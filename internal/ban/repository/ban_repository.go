...
func (s *banRepository) GetStats(ctx context.Context, stats *domain.Stats) error {
	const query = `
	SELECT 
...
func (s *banRepository) GetBanNetByAddress(ctx context.Context, ipAddr net.IP) ([]domain.BanCIDR, error) {
	const query = `
...
func (s *banRepository) GetBansNet(ctx context.Context, filter domain.CIDRBansQueryFilter) ([]domain.BannedCIDRPerson, int64, error) {
...
func (s *banRepository) updateBanNet(ctx context.Context, banNet *domain.BanCIDR) error {
...
func (s *banRepository) insertBanNet(ctx context.Context, banNet *domain.BanCIDR) error {
...
func (s *banRepository) SaveBanNet(ctx context.Context, banNet *domain.BanCIDR) error {
	if banNet.NetID > 0 {
...
func (s *banRepository) DropBanNet(ctx context.Context, banNet *domain.BanCIDR) error {
	query := s.
		Builder().
		Delete("ban_net").
		Where(sq.Eq{"net_id": banNet.NetID})
...
func (s *banRepository) GetExpiredNetBans(ctx context.Context) ([]domain.BanCIDR, error) {
	query := s.
		Builder().
...
func (s *banRepository) GetExpiredASNBans(ctx context.Context) ([]domain.BanASN, error) {
	query := s.
		Builder().
...
func (s *banRepository) GetBanNetByID(ctx context.Context, netID int64, banNet *domain.BanCIDR) error {
	const query = `
		SELECT net_id, cidr, origin, created_on, updated_on, reason, reason_text, valid_until, deleted, 
		       note, unban_reason_text, is_enabled, target_id, source_id, appeal_state
		FROM ban_net
...
func (s *banRepository) DropBan(ctx context.Context, ban *domain.BanSteam, hardDelete bool) error {
	if hardDelete {
...
func (s *banRepository) getBanByColumn(ctx context.Context, column string, identifier any, person *domain.BannedSteamPerson, deletedOk bool) error {
	whereClauses := sq.And{
...
func (s *banRepository) GetBanBySteamID(ctx context.Context, sid64 steamid.SID64, bannedPerson *domain.BannedSteamPerson, deletedOk bool) error {
	return s.getBanByColumn(ctx, "target_id", sid64, bannedPerson, deletedOk)
}

func (s *banRepository) GetBanByBanID(ctx context.Context, banID int64, bannedPerson *domain.BannedSteamPerson, deletedOk bool) error {
	return s.getBanByColumn(ctx, "ban_id", banID, bannedPerson, deletedOk)
}

func (s *banRepository) GetBanByLastIP(ctx context.Context, lastIP net.IP, bannedPerson *domain.BannedSteamPerson, deletedOk bool) error {
...
func (s *banRepository) SaveBan(ctx context.Context, ban *domain.BanSteam) error {
...
func (s *banRepository) insertBan(ctx context.Context, ban *domain.BanSteam) error {
	const query = `
...
func (s *banRepository) updateBan(ctx context.Context, ban *domain.BanSteam) error {
	var reportID *int64
	if ban.ReportID > 0 {
...
func (s *banRepository) GetExpiredBans(ctx context.Context) ([]domain.BanSteam, error) {
	query := s.
		Builder().
...
func (s *banRepository) GetBansSteam(ctx context.Context, filter domain.SteamBansQueryFilter) ([]domain.BannedSteamPerson, int64, error) {
	builder := s.
		Builder().
...
func (s *banRepository) GetBansOlderThan(ctx context.Context, filter domain.QueryFilter, since time.Time) ([]domain.BanSteam, error) {
	query := s.
		Builder().
		Select("s.ban_id", "s.target_id", "s.source_id", "s.ban_type", "s.reason",
...
func (s *banRepository) GetBanASN(ctx context.Context, asNum int64, banASN *domain.BanASN) error {
	const query = `
...
func (s *banRepository) GetBansASN(ctx context.Context, filter domain.ASNBansQueryFilter) ([]domain.BannedASNPerson, int64, error) {
	builder := s.
		Builder().
...
func (s *banRepository) SaveBanASN(ctx context.Context, banASN *domain.BanASN) error {
...
func (s *banRepository) DropBanASN(ctx context.Context, banASN *domain.BanASN) error {
	banASN.Deleted = true
