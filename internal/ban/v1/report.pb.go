...
const file_ban_v1_report_proto_rawDesc = "" +
	...
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\breportId\"E\n" +
	"\x12UserReportsRequest\x12/\n" +
	"\bsteam_id\x18\x01 \x01(\x03B\x14\xbaH\x0f\xc8\x01\x01\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x010\x01R\asteamId\"S\n" +
	...
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\x0freportMessageId\x121\n" +
	"\tauthor_id\x18\x03 \x01(\x03B\x14\xbaH\x0f\xc8\x01\x01\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x010\x01R\bauthorId\x12-\n" +
	"\n" +
	...
	"\tsource_id\x18\x02 \x01(\x03B\x14\xbaH\x0f\xc8\x01\x01\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x010\x01R\bsourceId\x121\n" +
	"\ttarget_id\x18\x03 \x01(\x03B\x14\xbaH\x0f\xc8\x01\x01\"\n" +
	...
	"\rreport_status\x18\x02 \x01(\x0e2\x14.ban.v1.ReportStatusB\x06\xbaH\x03\xc8\x01\x01R\freportStatus\"\x91\x04\n" +
	...
	"\x11person_message_id\x18\b \x01(\x03B\x020\x01R\x0fpersonMessageId:\x95\x01\xbaH\x91\x01\x1a\x8e\x01\n" +
