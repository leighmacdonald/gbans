...
// GetWarningChan provides a mock function with given fields:
func (_m *MockChatRepository) GetWarningChan() chan domain.NewUserWarning {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWarningChan")
	}

	var r0 chan domain.NewUserWarning
	if rf, ok := ret.Get(0).(func() chan domain.NewUserWarning); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(chan domain.NewUserWarning)
		}
	}
...
// MockChatRepository_GetWarningChan_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetWarningChan'
type MockChatRepository_GetWarningChan_Call struct {
	*mock.Call
}

// GetWarningChan is a helper method to define mock.On call
func (_e *MockChatRepository_Expecter) GetWarningChan() *MockChatRepository_GetWarningChan_Call {
	return &MockChatRepository_GetWarningChan_Call{Call: _e.mock.On("GetWarningChan")}
}

func (_c *MockChatRepository_GetWarningChan_Call) Run(run func()) *MockChatRepository_GetWarningChan_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockChatRepository_GetWarningChan_Call) Return(_a0 chan domain.NewUserWarning) *MockChatRepository_GetWarningChan_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockChatRepository_GetWarningChan_Call) RunAndReturn(run func() chan domain.NewUserWarning) *MockChatRepository_GetWarningChan_Call {
	_c.Call.Return(run)
	return _c
}
