...
func (_m *MockBanNetUsecase) GetByAddress(ctx context.Context, ipAddr net.IP) ([]domain.BanCIDR, error) {
...
func (_c *MockBanNetUsecase_GetByAddress_Call) Run(run func(ctx context.Context, ipAddr net.IP)) *MockBanNetUsecase_GetByAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanNetUsecase_GetByAddress_Call) RunAndReturn(run func(context.Context, net.IP) ([]domain.BanCIDR, error)) *MockBanNetUsecase_GetByAddress_Call {
	_c.Call.Return(run)
	return _c
}
