...
func (_m *MockAppealUsecase) GetAppealsByActivity(ctx context.Context, opts domain.AppealQueryFilter) ([]domain.AppealOverview, error) {
...
func (_c *MockAppealUsecase_GetAppealsByActivity_Call) Return(_a0 []domain.AppealOverview, _a1 error) *MockAppealUsecase_GetAppealsByActivity_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAppealUsecase_GetAppealsByActivity_Call) RunAndReturn(run func(context.Context, domain.AppealQueryFilter) ([]domain.AppealOverview, error)) *MockAppealUsecase_GetAppealsByActivity_Call {
	_c.Call.Return(run)
	return _c
}
