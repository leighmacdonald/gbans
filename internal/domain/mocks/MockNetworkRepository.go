...
func (_m *MockNetworkRepository) InsertBlockListData(ctx context.Context, log *zap.Logger, blockListData *ip2location.BlockListData) error {
...
func (_e *MockNetworkRepository_Expecter) InsertBlockListData(ctx interface{}, log interface{}, blockListData interface{}) *MockNetworkRepository_InsertBlockListData_Call {
	return &MockNetworkRepository_InsertBlockListData_Call{Call: _e.mock.On("InsertBlockListData", ctx, log, blockListData)}
}

func (_c *MockNetworkRepository_InsertBlockListData_Call) Run(run func(ctx context.Context, log *zap.Logger, blockListData *ip2location.BlockListData)) *MockNetworkRepository_InsertBlockListData_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockNetworkRepository_InsertBlockListData_Call) RunAndReturn(run func(context.Context, *zap.Logger, *ip2location.BlockListData) error) *MockNetworkRepository_InsertBlockListData_Call {
	_c.Call.Return(run)
	return _c
}
