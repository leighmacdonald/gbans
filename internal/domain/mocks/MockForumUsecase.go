...
// ForumCategoryDelete provides a mock function with given fields: ctx, categoryI
func (_m *MockForumUsecase) ForumCategoryDelete(ctx context.Context, categoryI domain.ForumCategory) error {
	ret := _m.Called(ctx, categoryI)
...
//   - ctx context.Context
//   - categoryI domain.ForumCategory
func (_e *MockForumUsecase_Expecter) ForumCategoryDelete(ctx interface{}, categoryI interface{}) *MockForumUsecase_ForumCategoryDelete_Call {
	return &MockForumUsecase_ForumCategoryDelete_Call{Call: _e.mock.On("ForumCategoryDelete", ctx, categoryI)}
}

func (_c *MockForumUsecase_ForumCategoryDelete_Call) Run(run func(ctx context.Context, categoryI domain.ForumCategory)) *MockForumUsecase_ForumCategoryDelete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockForumUsecase_ForumCategoryDelete_Call) RunAndReturn(run func(context.Context, domain.ForumCategory) error) *MockForumUsecase_ForumCategoryDelete_Call {
	_c.Call.Return(run)
	return _c
}
