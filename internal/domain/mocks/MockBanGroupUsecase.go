...
func (_m *MockBanGroupUsecase) Get(ctx context.Context, filter domain.GroupBansQueryFilter) ([]domain.BannedGroupPerson, error) {
...
func (_c *MockBanGroupUsecase_Get_Call) Return(_a0 []domain.BannedGroupPerson, _a1 error) *MockBanGroupUsecase_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBanGroupUsecase_Get_Call) RunAndReturn(run func(context.Context, domain.GroupBansQueryFilter) ([]domain.BannedGroupPerson, error)) *MockBanGroupUsecase_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetByGID provides a mock function with given fields: ctx, groupID, banGroup
func (_m *MockBanGroupUsecase) GetByGID(ctx context.Context, groupID steamid.SteamID, banGroup *domain.BanGroup) error {
...
func (_c *MockBanGroupUsecase_GetByGID_Call) Run(run func(ctx context.Context, groupID steamid.SteamID, banGroup *domain.BanGroup)) *MockBanGroupUsecase_GetByGID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanGroupUsecase_GetByGID_Call) RunAndReturn(run func(context.Context, steamid.SteamID, *domain.BanGroup) error) *MockBanGroupUsecase_GetByGID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockBanGroupUsecase) UpdateCache(ctx context.Context) error {
	ret := _m.Called(ctx)
...
// MockBanGroupUsecase_UpdateCache_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateCache'
type MockBanGroupUsecase_UpdateCache_Call struct {
	*mock.Call
}

// UpdateCache is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockBanGroupUsecase_Expecter) UpdateCache(ctx interface{}) *MockBanGroupUsecase_UpdateCache_Call {
	return &MockBanGroupUsecase_UpdateCache_Call{Call: _e.mock.On("UpdateCache", ctx)}
}

func (_c *MockBanGroupUsecase_UpdateCache_Call) Run(run func(ctx context.Context)) *MockBanGroupUsecase_UpdateCache_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanGroupUsecase_UpdateCache_Call) Return(_a0 error) *MockBanGroupUsecase_UpdateCache_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBanGroupUsecase_UpdateCache_Call) RunAndReturn(run func(context.Context) error) *MockBanGroupUsecase_UpdateCache_Call {
	_c.Call.Return(run)
	return _c
}
