...
func (_m *MockBanGroupUsecase) IsMember(steamID steamid.SteamID) (steamid.SteamID, bool) {
...
func (_c *MockBanGroupUsecase_IsMember_Call) Run(run func(steamID steamid.SteamID)) *MockBanGroupUsecase_IsMember_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanGroupUsecase_IsMember_Call) Return(_a0 steamid.SteamID, _a1 bool) *MockBanGroupUsecase_IsMember_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBanGroupUsecase_IsMember_Call) RunAndReturn(run func(steamid.SteamID) (steamid.SteamID, bool)) *MockBanGroupUsecase_IsMember_Call {
	_c.Call.Return(run)
	return _c
}
