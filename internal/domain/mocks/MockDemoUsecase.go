...
// MarkArchived provides a mock function with given fields: ctx, demo
func (_m *MockDemoUsecase) MarkArchived(ctx context.Context, demo *domain.DemoFile) error {
	ret := _m.Called(ctx, demo)
...
// MockDemoUsecase_MarkArchived_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MarkArchived'
type MockDemoUsecase_MarkArchived_Call struct {
	*mock.Call
}

// MarkArchived is a helper method to define mock.On call
//   - ctx context.Context
//   - demo *domain.DemoFile
func (_e *MockDemoUsecase_Expecter) MarkArchived(ctx interface{}, demo interface{}) *MockDemoUsecase_MarkArchived_Call {
	return &MockDemoUsecase_MarkArchived_Call{Call: _e.mock.On("MarkArchived", ctx, demo)}
}

func (_c *MockDemoUsecase_MarkArchived_Call) Run(run func(ctx context.Context, demo *domain.DemoFile)) *MockDemoUsecase_MarkArchived_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDemoUsecase_MarkArchived_Call) Return(_a0 error) *MockDemoUsecase_MarkArchived_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDemoUsecase_MarkArchived_Call) RunAndReturn(run func(context.Context, *domain.DemoFile) error) *MockDemoUsecase_MarkArchived_Call {
	_c.Call.Return(run)
	return _c
}

// OldestDemo provides a mock function with given fields: ctx
func (_m *MockDemoUsecase) OldestDemo(ctx context.Context) (domain.DemoInfo, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for OldestDemo")
	}

	var r0 domain.DemoInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (domain.DemoInfo, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) domain.DemoInfo); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(domain.DemoInfo)
	}
...
// MockDemoUsecase_OldestDemo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'OldestDemo'
type MockDemoUsecase_OldestDemo_Call struct {
	*mock.Call
}

// OldestDemo is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockDemoUsecase_Expecter) OldestDemo(ctx interface{}) *MockDemoUsecase_OldestDemo_Call {
	return &MockDemoUsecase_OldestDemo_Call{Call: _e.mock.On("OldestDemo", ctx)}
}

func (_c *MockDemoUsecase_OldestDemo_Call) Run(run func(ctx context.Context)) *MockDemoUsecase_OldestDemo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockDemoUsecase_OldestDemo_Call) Return(_a0 domain.DemoInfo, _a1 error) *MockDemoUsecase_OldestDemo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDemoUsecase_OldestDemo_Call) RunAndReturn(run func(context.Context) (domain.DemoInfo, error)) *MockDemoUsecase_OldestDemo_Call {
	_c.Call.Return(run)
	return _c
}
...
// TriggerCleanup provides a mock function with given fields:
func (_m *MockDemoUsecase) TriggerCleanup() {
	_m.Called()
}

// MockDemoUsecase_TriggerCleanup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TriggerCleanup'
type MockDemoUsecase_TriggerCleanup_Call struct {
	*mock.Call
}

// TriggerCleanup is a helper method to define mock.On call
func (_e *MockDemoUsecase_Expecter) TriggerCleanup() *MockDemoUsecase_TriggerCleanup_Call {
	return &MockDemoUsecase_TriggerCleanup_Call{Call: _e.mock.On("TriggerCleanup")}
}

func (_c *MockDemoUsecase_TriggerCleanup_Call) Run(run func()) *MockDemoUsecase_TriggerCleanup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockDemoUsecase_TriggerCleanup_Call) Return() *MockDemoUsecase_TriggerCleanup_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockDemoUsecase_TriggerCleanup_Call) RunAndReturn(run func()) *MockDemoUsecase_TriggerCleanup_Call {
	_c.Call.Return(run)
	return _c
}
