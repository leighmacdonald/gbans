...
func (_m *MockAuthRepository) GetPersonAuthByRefreshToken(ctx context.Context, token string, auth *domain.PersonAuth) error {
...
// MockAuthRepository_GetPersonAuthByRefreshToken_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPersonAuthByRefreshToken'
type MockAuthRepository_GetPersonAuthByRefreshToken_Call struct {
	*mock.Call
}
...
func (_e *MockAuthRepository_Expecter) GetPersonAuthByRefreshToken(ctx interface{}, token interface{}, auth interface{}) *MockAuthRepository_GetPersonAuthByRefreshToken_Call {
	return &MockAuthRepository_GetPersonAuthByRefreshToken_Call{Call: _e.mock.On("GetPersonAuthByRefreshToken", ctx, token, auth)}
}

func (_c *MockAuthRepository_GetPersonAuthByRefreshToken_Call) Run(run func(ctx context.Context, token string, auth *domain.PersonAuth)) *MockAuthRepository_GetPersonAuthByRefreshToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAuthRepository_GetPersonAuthByRefreshToken_Call) Return(_a0 error) *MockAuthRepository_GetPersonAuthByRefreshToken_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAuthRepository_GetPersonAuthByRefreshToken_Call) RunAndReturn(run func(context.Context, string, *domain.PersonAuth) error) *MockAuthRepository_GetPersonAuthByRefreshToken_Call {
	_c.Call.Return(run)
	return _c
}
