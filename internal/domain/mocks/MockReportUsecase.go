...
func (_m *MockReportUsecase) GetReports(ctx context.Context) ([]domain.ReportWithAuthor, error) {
	ret := _m.Called(ctx)
	...
	var r0 []domain.ReportWithAuthor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]domain.ReportWithAuthor, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []domain.ReportWithAuthor); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.ReportWithAuthor)
...
//   - ctx context.Context
func (_e *MockReportUsecase_Expecter) GetReports(ctx interface{}) *MockReportUsecase_GetReports_Call {
	return &MockReportUsecase_GetReports_Call{Call: _e.mock.On("GetReports", ctx)}
}

func (_c *MockReportUsecase_GetReports_Call) Run(run func(ctx context.Context)) *MockReportUsecase_GetReports_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReportUsecase_GetReports_Call) Return(_a0 []domain.ReportWithAuthor, _a1 error) *MockReportUsecase_GetReports_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReportUsecase_GetReports_Call) RunAndReturn(run func(context.Context) ([]domain.ReportWithAuthor, error)) *MockReportUsecase_GetReports_Call {
	_c.Call.Return(run)
	return _c
}

// GetReportsBySteamID provides a mock function with given fields: ctx, steamID
func (_m *MockReportUsecase) GetReportsBySteamID(ctx context.Context, steamID steamid.SteamID) ([]domain.ReportWithAuthor, error) {
	ret := _m.Called(ctx, steamID)

	if len(ret) == 0 {
		panic("no return value specified for GetReportsBySteamID")
	}

	var r0 []domain.ReportWithAuthor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, steamid.SteamID) ([]domain.ReportWithAuthor, error)); ok {
		return rf(ctx, steamID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, steamid.SteamID) []domain.ReportWithAuthor); ok {
		r0 = rf(ctx, steamID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.ReportWithAuthor)
...
// MockReportUsecase_GetReportsBySteamID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetReportsBySteamID'
type MockReportUsecase_GetReportsBySteamID_Call struct {
	*mock.Call
}

// GetReportsBySteamID is a helper method to define mock.On call
//   - ctx context.Context
//   - steamID steamid.SteamID
func (_e *MockReportUsecase_Expecter) GetReportsBySteamID(ctx interface{}, steamID interface{}) *MockReportUsecase_GetReportsBySteamID_Call {
	return &MockReportUsecase_GetReportsBySteamID_Call{Call: _e.mock.On("GetReportsBySteamID", ctx, steamID)}
}

func (_c *MockReportUsecase_GetReportsBySteamID_Call) Run(run func(ctx context.Context, steamID steamid.SteamID)) *MockReportUsecase_GetReportsBySteamID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReportUsecase_GetReportsBySteamID_Call) Return(_a0 []domain.ReportWithAuthor, _a1 error) *MockReportUsecase_GetReportsBySteamID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReportUsecase_GetReportsBySteamID_Call) RunAndReturn(run func(context.Context, steamid.SteamID) ([]domain.ReportWithAuthor, error)) *MockReportUsecase_GetReportsBySteamID_Call {
	_c.Call.Return(run)
	return _c
}
