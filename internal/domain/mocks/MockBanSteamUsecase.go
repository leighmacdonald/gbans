...
// CheckEvadeStatus provides a mock function with given fields: ctx, curUser, steamID, address
func (_m *MockBanSteamUsecase) CheckEvadeStatus(ctx context.Context, curUser domain.PersonInfo, steamID steamid.SteamID, address netip.Addr) (bool, error) {
	ret := _m.Called(ctx, curUser, steamID, address)

	if len(ret) == 0 {
		panic("no return value specified for CheckEvadeStatus")
	}
...
// MockBanSteamUsecase_CheckEvadeStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckEvadeStatus'
type MockBanSteamUsecase_CheckEvadeStatus_Call struct {
	*mock.Call
}

// CheckEvadeStatus is a helper method to define mock.On call
//   - ctx context.Context
//   - curUser domain.PersonInfo
//   - steamID steamid.SteamID
//   - address netip.Addr
func (_e *MockBanSteamUsecase_Expecter) CheckEvadeStatus(ctx interface{}, curUser interface{}, steamID interface{}, address interface{}) *MockBanSteamUsecase_CheckEvadeStatus_Call {
	return &MockBanSteamUsecase_CheckEvadeStatus_Call{Call: _e.mock.On("CheckEvadeStatus", ctx, curUser, steamID, address)}
}

func (_c *MockBanSteamUsecase_CheckEvadeStatus_Call) Run(run func(ctx context.Context, curUser domain.PersonInfo, steamID steamid.SteamID, address netip.Addr)) *MockBanSteamUsecase_CheckEvadeStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanSteamUsecase_CheckEvadeStatus_Call) Return(_a0 bool, _a1 error) *MockBanSteamUsecase_CheckEvadeStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBanSteamUsecase_CheckEvadeStatus_Call) RunAndReturn(run func(context.Context, domain.PersonInfo, steamid.SteamID, netip.Addr) (bool, error)) *MockBanSteamUsecase_CheckEvadeStatus_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockBanSteamUsecase) Get(ctx context.Context, filter domain.SteamBansQueryFilter) ([]domain.BannedSteamPerson, error) {
...
func (_c *MockBanSteamUsecase_Get_Call) Return(_a0 []domain.BannedSteamPerson, _a1 error) *MockBanSteamUsecase_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBanSteamUsecase_Get_Call) RunAndReturn(run func(context.Context, domain.SteamBansQueryFilter) ([]domain.BannedSteamPerson, error)) *MockBanSteamUsecase_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetByBanID provides a mock function with given fields: ctx, banID, deletedOk, evadeOK
func (_m *MockBanSteamUsecase) GetByBanID(ctx context.Context, banID int64, deletedOk bool, evadeOK bool) (domain.BannedSteamPerson, error) {
...
//   - deletedOk bool
//   - evadeOK bool
func (_e *MockBanSteamUsecase_Expecter) GetByBanID(ctx interface{}, banID interface{}, deletedOk interface{}, evadeOK interface{}) *MockBanSteamUsecase_GetByBanID_Call {
	return &MockBanSteamUsecase_GetByBanID_Call{Call: _e.mock.On("GetByBanID", ctx, banID, deletedOk, evadeOK)}
}

func (_c *MockBanSteamUsecase_GetByBanID_Call) Run(run func(ctx context.Context, banID int64, deletedOk bool, evadeOK bool)) *MockBanSteamUsecase_GetByBanID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanSteamUsecase_GetByBanID_Call) RunAndReturn(run func(context.Context, int64, bool, bool) (domain.BannedSteamPerson, error)) *MockBanSteamUsecase_GetByBanID_Call {
	_c.Call.Return(run)
	return _c
}

// GetByLastIP provides a mock function with given fields: ctx, lastIP, deletedOk, evadeOK
func (_m *MockBanSteamUsecase) GetByLastIP(ctx context.Context, lastIP netip.Addr, deletedOk bool, evadeOK bool) (domain.BannedSteamPerson, error) {
...
//   - deletedOk bool
//   - evadeOK bool
func (_e *MockBanSteamUsecase_Expecter) GetByLastIP(ctx interface{}, lastIP interface{}, deletedOk interface{}, evadeOK interface{}) *MockBanSteamUsecase_GetByLastIP_Call {
	return &MockBanSteamUsecase_GetByLastIP_Call{Call: _e.mock.On("GetByLastIP", ctx, lastIP, deletedOk, evadeOK)}
}

func (_c *MockBanSteamUsecase_GetByLastIP_Call) Run(run func(ctx context.Context, lastIP netip.Addr, deletedOk bool, evadeOK bool)) *MockBanSteamUsecase_GetByLastIP_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanSteamUsecase_GetByLastIP_Call) RunAndReturn(run func(context.Context, netip.Addr, bool, bool) (domain.BannedSteamPerson, error)) *MockBanSteamUsecase_GetByLastIP_Call {
	_c.Call.Return(run)
	return _c
}

// GetBySteamID provides a mock function with given fields: ctx, sid64, deletedOk, evadeOK
func (_m *MockBanSteamUsecase) GetBySteamID(ctx context.Context, sid64 steamid.SteamID, deletedOk bool, evadeOK bool) (domain.BannedSteamPerson, error) {
...
//   - deletedOk bool
//   - evadeOK bool
func (_e *MockBanSteamUsecase_Expecter) GetBySteamID(ctx interface{}, sid64 interface{}, deletedOk interface{}, evadeOK interface{}) *MockBanSteamUsecase_GetBySteamID_Call {
	return &MockBanSteamUsecase_GetBySteamID_Call{Call: _e.mock.On("GetBySteamID", ctx, sid64, deletedOk, evadeOK)}
}

func (_c *MockBanSteamUsecase_GetBySteamID_Call) Run(run func(ctx context.Context, sid64 steamid.SteamID, deletedOk bool, evadeOK bool)) *MockBanSteamUsecase_GetBySteamID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanSteamUsecase_GetBySteamID_Call) RunAndReturn(run func(context.Context, steamid.SteamID, bool, bool) (domain.BannedSteamPerson, error)) *MockBanSteamUsecase_GetBySteamID_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateCache provides a mock function with given fields: ctx
func (_m *MockBanSteamUsecase) UpdateCache(ctx context.Context) error {
	ret := _m.Called(ctx)
...
// MockBanSteamUsecase_UpdateCache_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateCache'
type MockBanSteamUsecase_UpdateCache_Call struct {
	*mock.Call
}

// UpdateCache is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockBanSteamUsecase_Expecter) UpdateCache(ctx interface{}) *MockBanSteamUsecase_UpdateCache_Call {
	return &MockBanSteamUsecase_UpdateCache_Call{Call: _e.mock.On("UpdateCache", ctx)}
}

func (_c *MockBanSteamUsecase_UpdateCache_Call) Run(run func(ctx context.Context)) *MockBanSteamUsecase_UpdateCache_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockBanSteamUsecase_UpdateCache_Call) Return(_a0 error) *MockBanSteamUsecase_UpdateCache_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBanSteamUsecase_UpdateCache_Call) RunAndReturn(run func(context.Context) error) *MockBanSteamUsecase_UpdateCache_Call {
	_c.Call.Return(run)
	return _c
}
