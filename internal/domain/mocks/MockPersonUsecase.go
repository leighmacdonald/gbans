...
func (_m *MockPersonUsecase) DropPerson(ctx context.Context, steamID steamid.SID64) error {
...
func (_c *MockPersonUsecase_DropPerson_Call) Run(run func(ctx context.Context, steamID steamid.SID64)) *MockPersonUsecase_DropPerson_Call {
...
func (_c *MockPersonUsecase_DropPerson_Call) RunAndReturn(run func(context.Context, steamid.SID64) error) *MockPersonUsecase_DropPerson_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockPersonUsecase) GetOrCreatePersonBySteamID(ctx context.Context, sid64 steamid.SID64) (domain.Person, error) {
...
func (_c *MockPersonUsecase_GetOrCreatePersonBySteamID_Call) Run(run func(ctx context.Context, sid64 steamid.SID64)) *MockPersonUsecase_GetOrCreatePersonBySteamID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(steamid.SID64))
	})
	return _c
...
func (_c *MockPersonUsecase_GetOrCreatePersonBySteamID_Call) RunAndReturn(run func(context.Context, steamid.SID64) (domain.Person, error)) *MockPersonUsecase_GetOrCreatePersonBySteamID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockPersonUsecase) GetPersonBySteamID(ctx context.Context, sid64 steamid.SID64) (domain.Person, error) {
	ret := _m.Called(ctx, sid64)
...
func (_c *MockPersonUsecase_GetPersonBySteamID_Call) Run(run func(ctx context.Context, sid64 steamid.SID64)) *MockPersonUsecase_GetPersonBySteamID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(steamid.SID64))
	})
	return _c
...
func (_c *MockPersonUsecase_GetPersonBySteamID_Call) RunAndReturn(run func(context.Context, steamid.SID64) (domain.Person, error)) *MockPersonUsecase_GetPersonBySteamID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockPersonUsecase) GetPersonSettings(ctx context.Context, steamID steamid.SID64) (domain.PersonSettings, error) {
	ret := _m.Called(ctx, steamID)
...
func (_c *MockPersonUsecase_GetPersonSettings_Call) Run(run func(ctx context.Context, steamID steamid.SID64)) *MockPersonUsecase_GetPersonSettings_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(steamid.SID64))
	})
	return _c
...
func (_c *MockPersonUsecase_GetPersonSettings_Call) RunAndReturn(run func(context.Context, steamid.SID64) (domain.PersonSettings, error)) *MockPersonUsecase_GetPersonSettings_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockPersonUsecase) QueryProfile(ctx context.Context, query string) (domain.ProfileReponse, error) {
	...
	var r0 domain.ProfileReponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (domain.ProfileReponse, error)); ok {
		return rf(ctx, query)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) domain.ProfileReponse); ok {
		r0 = rf(ctx, query)
	} else {
		r0 = ret.Get(0).(domain.ProfileReponse)
	}
...
func (_c *MockPersonUsecase_QueryProfile_Call) Return(_a0 domain.ProfileReponse, _a1 error) *MockPersonUsecase_QueryProfile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPersonUsecase_QueryProfile_Call) RunAndReturn(run func(context.Context, string) (domain.ProfileReponse, error)) *MockPersonUsecase_QueryProfile_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockPersonUsecase) SetPermissionLevel(ctx context.Context, steamID steamid.SID64, level domain.Privilege) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, steamid.SID64, domain.Privilege) error); ok {
...
func (_c *MockPersonUsecase_SetPermissionLevel_Call) Run(run func(ctx context.Context, steamID steamid.SID64, level domain.Privilege)) *MockPersonUsecase_SetPermissionLevel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(steamid.SID64), args[2].(domain.Privilege))
	})
	return _c
}
...
func (_c *MockPersonUsecase_SetPermissionLevel_Call) RunAndReturn(run func(context.Context, steamid.SID64, domain.Privilege) error) *MockPersonUsecase_SetPermissionLevel_Call {
	_c.Call.Return(run)
	return _c
}

// SetSteam provides a mock function with given fields: ctx, sid64, discordID
func (_m *MockPersonUsecase) SetSteam(ctx context.Context, sid64 steamid.SID64, discordID string) error {
...
func (_c *MockPersonUsecase_SetSteam_Call) Run(run func(ctx context.Context, sid64 steamid.SID64, discordID string)) *MockPersonUsecase_SetSteam_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPersonUsecase_SetSteam_Call) RunAndReturn(run func(context.Context, steamid.SID64, string) error) *MockPersonUsecase_SetSteam_Call {
	_c.Call.Return(run)
	return _c
}
