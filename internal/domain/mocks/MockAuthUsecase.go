...
// MakeToken provides a mock function with given fields: ctx, cookieKey, sid
func (_m *MockAuthUsecase) MakeToken(ctx *gin.Context, cookieKey string, sid steamid.SteamID) (domain.UserTokens, error) {
	ret := _m.Called(ctx, cookieKey, sid)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*gin.Context, string, steamid.SteamID) (domain.UserTokens, error)); ok {
		return rf(ctx, cookieKey, sid)
	}
	if rf, ok := ret.Get(0).(func(*gin.Context, string, steamid.SteamID) domain.UserTokens); ok {
		r0 = rf(ctx, cookieKey, sid)
	} else {
		r0 = ret.Get(0).(domain.UserTokens)
	}

	if rf, ok := ret.Get(1).(func(*gin.Context, string, steamid.SteamID) error); ok {
		r1 = rf(ctx, cookieKey, sid)
	} else {
		r1 = ret.Error(1)
	}
...
// MockAuthUsecase_MakeToken_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MakeToken'
type MockAuthUsecase_MakeToken_Call struct {
	*mock.Call
}
...
//   - cookieKey string
//   - sid steamid.SteamID
func (_e *MockAuthUsecase_Expecter) MakeToken(ctx interface{}, cookieKey interface{}, sid interface{}) *MockAuthUsecase_MakeToken_Call {
	return &MockAuthUsecase_MakeToken_Call{Call: _e.mock.On("MakeToken", ctx, cookieKey, sid)}
}

func (_c *MockAuthUsecase_MakeToken_Call) Run(run func(ctx *gin.Context, cookieKey string, sid steamid.SteamID)) *MockAuthUsecase_MakeToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gin.Context), args[1].(string), args[2].(steamid.SteamID))
	})
	return _c
}

func (_c *MockAuthUsecase_MakeToken_Call) Return(_a0 domain.UserTokens, _a1 error) *MockAuthUsecase_MakeToken_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAuthUsecase_MakeToken_Call) RunAndReturn(run func(*gin.Context, string, steamid.SteamID) (domain.UserTokens, error)) *MockAuthUsecase_MakeToken_Call {
	_c.Call.Return(run)
	return _c
}
...
// Sid64FromJWTToken provides a mock function with given fields: token, cookieKey, fingerprint
func (_m *MockAuthUsecase) Sid64FromJWTToken(token string, cookieKey string, fingerprint string) (steamid.SteamID, error) {
	ret := _m.Called(token, cookieKey, fingerprint)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string) (steamid.SteamID, error)); ok {
		return rf(token, cookieKey, fingerprint)
	}
	if rf, ok := ret.Get(0).(func(string, string, string) steamid.SteamID); ok {
		r0 = rf(token, cookieKey, fingerprint)
	} else {
		r0 = ret.Get(0).(steamid.SteamID)
	}

	if rf, ok := ret.Get(1).(func(string, string, string) error); ok {
		r1 = rf(token, cookieKey, fingerprint)
	} else {
		r1 = ret.Error(1)
	}
...
//   - cookieKey string
//   - fingerprint string
func (_e *MockAuthUsecase_Expecter) Sid64FromJWTToken(token interface{}, cookieKey interface{}, fingerprint interface{}) *MockAuthUsecase_Sid64FromJWTToken_Call {
	return &MockAuthUsecase_Sid64FromJWTToken_Call{Call: _e.mock.On("Sid64FromJWTToken", token, cookieKey, fingerprint)}
}

func (_c *MockAuthUsecase_Sid64FromJWTToken_Call) Run(run func(token string, cookieKey string, fingerprint string)) *MockAuthUsecase_Sid64FromJWTToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockAuthUsecase_Sid64FromJWTToken_Call) RunAndReturn(run func(string, string, string) (steamid.SteamID, error)) *MockAuthUsecase_Sid64FromJWTToken_Call {
	_c.Call.Return(run)
	return _c
}
