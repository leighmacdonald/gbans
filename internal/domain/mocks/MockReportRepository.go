...
// GetReports provides a mock function with given fields: ctx, steamID
func (_m *MockReportRepository) GetReports(ctx context.Context, steamID steamid.SteamID) ([]domain.Report, error) {
	...
	var r0 []domain.Report
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, steamid.SteamID) ([]domain.Report, error)); ok {
		return rf(ctx, steamID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, steamid.SteamID) []domain.Report); ok {
		r0 = rf(ctx, steamID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.Report)
...
//   - ctx context.Context
//   - steamID steamid.SteamID
func (_e *MockReportRepository_Expecter) GetReports(ctx interface{}, steamID interface{}) *MockReportRepository_GetReports_Call {
	return &MockReportRepository_GetReports_Call{Call: _e.mock.On("GetReports", ctx, steamID)}
}

func (_c *MockReportRepository_GetReports_Call) Run(run func(ctx context.Context, steamID steamid.SteamID)) *MockReportRepository_GetReports_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReportRepository_GetReports_Call) Return(_a0 []domain.Report, _a1 error) *MockReportRepository_GetReports_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockReportRepository_GetReports_Call) RunAndReturn(run func(context.Context, steamid.SteamID) ([]domain.Report, error)) *MockReportRepository_GetReports_Call {
	_c.Call.Return(run)
	return _c
}
