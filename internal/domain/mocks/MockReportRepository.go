...
func (_m *MockReportRepository) GetReportBySteamID(ctx context.Context, authorID steamid.SID64, steamID steamid.SID64) (domain.Report, error) {
...
func (_c *MockReportRepository_GetReportBySteamID_Call) Run(run func(ctx context.Context, authorID steamid.SID64, steamID steamid.SID64)) *MockReportRepository_GetReportBySteamID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReportRepository_GetReportBySteamID_Call) RunAndReturn(run func(context.Context, steamid.SID64, steamid.SID64) (domain.Report, error)) *MockReportRepository_GetReportBySteamID_Call {
	_c.Call.Return(run)
	return _c
}
