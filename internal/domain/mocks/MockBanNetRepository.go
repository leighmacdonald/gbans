...
func (_m *MockBanNetRepository) Get(ctx context.Context, filter domain.CIDRBansQueryFilter) ([]domain.BannedCIDRPerson, error) {
...
func (_c *MockBanNetRepository_Get_Call) Return(_a0 []domain.BannedCIDRPerson, _a1 error) *MockBanNetRepository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBanNetRepository_Get_Call) RunAndReturn(run func(context.Context, domain.CIDRBansQueryFilter) ([]domain.BannedCIDRPerson, error)) *MockBanNetRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetByAddress provides a mock function with given fields: ctx, ipAddr
func (_m *MockBanNetRepository) GetByAddress(ctx context.Context, ipAddr netip.Addr) ([]domain.BanCIDR, error) {
...
func (_c *MockBanNetRepository_GetByAddress_Call) Run(run func(ctx context.Context, ipAddr netip.Addr)) *MockBanNetRepository_GetByAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBanNetRepository_GetByAddress_Call) RunAndReturn(run func(context.Context, netip.Addr) ([]domain.BanCIDR, error)) *MockBanNetRepository_GetByAddress_Call {
	_c.Call.Return(run)
	return _c
}
