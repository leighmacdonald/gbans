...
func (_m *MockStateUsecase) Find(name string, steamID steamid.SteamID, addr net.IP, cidr *net.IPNet) []domain.PlayerServerInfo {
	...
	if rf, ok := ret.Get(0).(func(string, steamid.SteamID, net.IP, *net.IPNet) []domain.PlayerServerInfo); ok {
...
func (_c *MockStateUsecase_Find_Call) Run(run func(name string, steamID steamid.SteamID, addr net.IP, cidr *net.IPNet)) *MockStateUsecase_Find_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(steamid.SteamID), args[2].(net.IP), args[3].(*net.IPNet))
	})
	return _c
}
...
func (_c *MockStateUsecase_Find_Call) RunAndReturn(run func(string, steamid.SteamID, net.IP, *net.IPNet) []domain.PlayerServerInfo) *MockStateUsecase_Find_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStateUsecase) FindBySteamID(steamID steamid.SteamID) []domain.PlayerServerInfo {
	...
	var r0 []domain.PlayerServerInfo
	if rf, ok := ret.Get(0).(func(steamid.SteamID) []domain.PlayerServerInfo); ok {
		r0 = rf(steamID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.PlayerServerInfo)
...
func (_c *MockStateUsecase_FindBySteamID_Call) Run(run func(steamID steamid.SteamID)) *MockStateUsecase_FindBySteamID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStateUsecase_FindBySteamID_Call) RunAndReturn(run func(steamid.SteamID) []domain.PlayerServerInfo) *MockStateUsecase_FindBySteamID_Call {
	_c.Call.Return(run)
	return _c
}

// Kick provides a mock function with given fields: ctx, target, reason
func (_m *MockStateUsecase) Kick(ctx context.Context, target steamid.SteamID, reason domain.Reason) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, steamid.SteamID, domain.Reason) error); ok {
...
func (_c *MockStateUsecase_Kick_Call) Run(run func(ctx context.Context, target steamid.SteamID, reason domain.Reason)) *MockStateUsecase_Kick_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(steamid.SteamID), args[2].(domain.Reason))
	})
	return _c
}
...
func (_c *MockStateUsecase_Kick_Call) RunAndReturn(run func(context.Context, steamid.SteamID, domain.Reason) error) *MockStateUsecase_Kick_Call {
	_c.Call.Return(run)
	return _c
}

// KickPlayerID provides a mock function with given fields: ctx, targetPlayerID, targetServerID, reason
func (_m *MockStateUsecase) KickPlayerID(ctx context.Context, targetPlayerID int, targetServerID int, reason domain.Reason) error {
	ret := _m.Called(ctx, targetPlayerID, targetServerID, reason)

	if len(ret) == 0 {
		panic("no return value specified for KickPlayerID")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, domain.Reason) error); ok {
		r0 = rf(ctx, targetPlayerID, targetServerID, reason)
	} else {
		r0 = ret.Error(0)
	}
...
// MockStateUsecase_KickPlayerID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'KickPlayerID'
type MockStateUsecase_KickPlayerID_Call struct {
	*mock.Call
}

// KickPlayerID is a helper method to define mock.On call
//   - ctx context.Context
//   - targetPlayerID int
//   - targetServerID int
//   - reason domain.Reason
func (_e *MockStateUsecase_Expecter) KickPlayerID(ctx interface{}, targetPlayerID interface{}, targetServerID interface{}, reason interface{}) *MockStateUsecase_KickPlayerID_Call {
	return &MockStateUsecase_KickPlayerID_Call{Call: _e.mock.On("KickPlayerID", ctx, targetPlayerID, targetServerID, reason)}
}

func (_c *MockStateUsecase_KickPlayerID_Call) Run(run func(ctx context.Context, targetPlayerID int, targetServerID int, reason domain.Reason)) *MockStateUsecase_KickPlayerID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int), args[2].(int), args[3].(domain.Reason))
	})
	return _c
}

func (_c *MockStateUsecase_KickPlayerID_Call) Return(_a0 error) *MockStateUsecase_KickPlayerID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStateUsecase_KickPlayerID_Call) RunAndReturn(run func(context.Context, int, int, domain.Reason) error) *MockStateUsecase_KickPlayerID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStateUsecase) OnFindExec(ctx context.Context, name string, steamID steamid.SteamID, ip net.IP, cidr *net.IPNet, onFoundCmd func(domain.PlayerServerInfo) string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, steamid.SteamID, net.IP, *net.IPNet, func(domain.PlayerServerInfo) string) error); ok {
...
func (_c *MockStateUsecase_OnFindExec_Call) Run(run func(ctx context.Context, name string, steamID steamid.SteamID, ip net.IP, cidr *net.IPNet, onFoundCmd func(domain.PlayerServerInfo) string)) *MockStateUsecase_OnFindExec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(steamid.SteamID), args[3].(net.IP), args[4].(*net.IPNet), args[5].(func(domain.PlayerServerInfo) string))
	})
	return _c
}
...
func (_c *MockStateUsecase_OnFindExec_Call) RunAndReturn(run func(context.Context, string, steamid.SteamID, net.IP, *net.IPNet, func(domain.PlayerServerInfo) string) error) *MockStateUsecase_OnFindExec_Call {
	_c.Call.Return(run)
	return _c
}

// PSay provides a mock function with given fields: ctx, target, message
func (_m *MockStateUsecase) PSay(ctx context.Context, target steamid.SteamID, message string) error {
...
func (_c *MockStateUsecase_PSay_Call) Run(run func(ctx context.Context, target steamid.SteamID, message string)) *MockStateUsecase_PSay_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockStateUsecase_PSay_Call) RunAndReturn(run func(context.Context, steamid.SteamID, string) error) *MockStateUsecase_PSay_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockStateUsecase) Silence(ctx context.Context, target steamid.SteamID, reason domain.Reason) error {
	ret := _m.Called(ctx, target, reason)
...
func (_c *MockStateUsecase_Silence_Call) Run(run func(ctx context.Context, target steamid.SteamID, reason domain.Reason)) *MockStateUsecase_Silence_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(steamid.SteamID), args[2].(domain.Reason))
	})
	return _c
...
func (_c *MockStateUsecase_Silence_Call) RunAndReturn(run func(context.Context, steamid.SteamID, domain.Reason) error) *MockStateUsecase_Silence_Call {
	_c.Call.Return(run)
	return _c
}
