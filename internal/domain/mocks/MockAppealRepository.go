...
func (_m *MockAppealRepository) GetAppealsByActivity(ctx context.Context, opts domain.AppealQueryFilter) ([]domain.AppealOverview, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.AppealQueryFilter) ([]domain.AppealOverview, error)); ok {
		return rf(ctx, opts)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, domain.AppealQueryFilter) error); ok {
		r1 = rf(ctx, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockAppealRepository_GetAppealsByActivity_Call) Return(_a0 []domain.AppealOverview, _a1 error) *MockAppealRepository_GetAppealsByActivity_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAppealRepository_GetAppealsByActivity_Call) RunAndReturn(run func(context.Context, domain.AppealQueryFilter) ([]domain.AppealOverview, error)) *MockAppealRepository_GetAppealsByActivity_Call {
	_c.Call.Return(run)
	return _c
}
