...
func NewSpeedrunsHandler(engine *gin.Engine, speedruns SpeedrunUsecase, auth httphelper.Authenticator, config *config.ConfigUsecase, serversUC ServersUsecase) {
