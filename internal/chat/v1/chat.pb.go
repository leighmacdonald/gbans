...
const file_chat_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x12chat/v1/chat.proto\x12\achat.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1edatabase/query/v1/filter.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"v\n" +
	"\x13QueryContextRequest\x126\n" +
	"\x11person_message_id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x0fpersonMessageId\x12'\n" +
	"\apadding\x18\x02 \x01(\x05B\r\xbaH\n" +
	"\xc8\x01\x01\x1a\x05\x10\xfa\x01 \x00R\apadding\"L\n" +
	"\x14QueryContextResponse\x124\n" +
	"\bmessages\x18\x01 \x03(\v2\x10.chat.v1.MessageB\x06\xbaH\x03\xc8\x01\x01R\bmessages\"\xbe\x02\n" +
	"\fQueryRequest\x121\n" +
	...
	"\bsteam_id\x18\a \x01(\x03B\x0f\xbaH\f\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x01R\asteamId\"c\n" +
	"\rQueryResponse\x124\n" +
	"\bmessages\x18\x01 \x03(\v2\x10.chat.v1.MessageB\x06\xbaH\x03\xc8\x01\x01R\bmessages\x12\x1c\n" +
	"\x05count\x18\x02 \x01(\x03B\x06\xbaH\x03\xc8\x01\x01R\x05count\"\x80\x04\n" +
	"\aMessage\x126\n" +
	"\x11person_message_id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x0fpersonMessageId\x12#\n" +
	...
	"\xc8\x01\x01r\x05\x10\x01\x18\x80\x01R\x04body\x12\x1a\n" +
