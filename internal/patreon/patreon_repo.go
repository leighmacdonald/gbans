...
func (r Repository) SaveTokens(ctx context.Context, creds Credential) error {
	...
	return database.Err(r.Exec(ctx, query, creds.SteamID.Int64(), creds.PatreonID, creds.AccessToken, creds.RefreshToken,
