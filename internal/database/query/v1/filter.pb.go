...
const file_database_query_v1_filter_proto_rawDesc = "" +
	"\n" +
	"\x1edatabase/query/v1/filter.proto\x12\x11database.query.v1\x1a\x1bbuf/validate/validate.proto\"{\n" +
	"\x06Filter\x12!\n" +
	"\x06offset\x18\x01 \x01(\x04B\t\xbaH\x042\x02 \x000\x01R\x06offset\x12\x1f\n" +
	"\x05limit\x18\x02 \x01(\x04B\t\xbaH\x042\x02 \x000\x01R\x05limit\x12\x12\n" +
