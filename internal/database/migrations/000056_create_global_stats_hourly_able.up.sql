...
ALTER TABLE IF EXISTS global_stats_players
ADD COLUMN IF NOT EXISTS regions jsonb default '{}' not null;
...
add constraint global_stats_players_hourly_created_on_uidx unique (created_on);
...
add constraint global_stats_players_daily_created_on_uidx unique (created_on);

alter table if exists ban
alter column created_on type timestamptz using created_on::timestamptz;

alter table if exists ban
alter column updated_on type timestamptz using updated_on::timestamptz;
...
alter table if exists ban_group
alter column created_on type timestamptz using created_on::timestamptz;
...
alter table if exists ban_appeal
alter column created_on type timestamptz using created_on::timestamptz;

alter table if exists ban_appeal
alter column updated_on type timestamptz using updated_on::timestamptz;

alter table if exists filtered_word
alter column created_on type timestamptz using created_on::timestamptz;

alter table if exists filtered_word
alter column discord_created_on type timestamptz using discord_created_on::timestamptz;

alter table if exists match
alter column created_on type timestamptz using created_on::timestamptz;

alter table if exists match_player
alter column time_start type timestamptz using time_start::timestamptz;

alter table if exists match_player
alter column time_end type timestamptz using time_end::timestamptz;
...
alter table if exists person
alter column updated_on type timestamptz using updated_on_steam::timestamptz;

alter table if exists person_connections
alter column created_on type timestamptz using created_on::timestamptz;
...
alter table if exists report_message
alter column created_on type timestamptz using created_on::timestamptz;
...
alter table if exists server
alter column token_created_on type timestamptz using token_created_on::timestamptz;

alter table if exists wiki
alter column created_on type timestamptz using created_on::timestamptz;
