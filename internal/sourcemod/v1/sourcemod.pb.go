...
func (x *Admin) GetAuthType() string {
	if x != nil && x.AuthType != nil {
		return *x.AuthType
	}
	return ""
...
const file_sourcemod_v1_sourcemod_proto_rawDesc = "" +
	"\n" +
	"\x1csourcemod/v1/sourcemod.proto\x12\fsourcemod.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x97\x02\n" +
	"\x05Group\x12%\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\agroupId\x12\x1c\n" +
	"\x05flags\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05flags\x12\x1e\n" +
	"\x04name\x18\x03 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x123\n" +
	"\x0eimmunity_level\x18\x04 \x01(\x05B\f\xbaH\t\xc8\x01\x01\x1a\x04\x18d(\x00R\rimmunityLevel\x129\n" +
	"\n" +
	...
	"\x06groups\x18\x01 \x03(\v2\x13.sourcemod.v1.GroupB\x06\xbaH\x03\xc8\x01\x01R\x06groups\"y\n" +
	...
	"\x05group\x18\x01 \x01(\v2\x13.sourcemod.v1.GroupB\x06\xbaH\x03\xc8\x01\x01R\x05group\"\x9f\x01\n" +
	"\x11EditGroupsRequest\x12%\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\x12\x1e\n" +
	...
	"\x05group\x18\x01 \x01(\v2\x13.sourcemod.v1.GroupB\x06\xbaH\x03\xc8\x01\x01R\x05group\";\n" +
	"\x12DeleteGroupRequest\x12%\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\">\n" +
	"\x15GroupOverridesRequest\x12%\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\"\\\n" +
	"\x16GroupOverridesResponse\x12B\n" +
	"\toverrides\x18\x01 \x03(\v2\x1c.sourcemod.v1.GroupOverridesB\x06\xbaH\x03\xc8\x01\x01R\toverrides\"\x9b\x02\n" +
	"\x1aCreateGroupOverrideRequest\x126\n" +
	"\x11group_override_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\x0fgroupOverrideId\x12%\n" +
	"\bgroup_id\x18\x02 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\x12;\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1a.sourcemod.v1.OverrideTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12\x1e\n" +
	"\x04name\x18\x04 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12A\n" +
	"\x06access\x18\x05 \x01(\x0e2\x1c.sourcemod.v1.OverrideAccessB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x06access\"j\n" +
	"\x1bCreateGroupOverrideResponse\x12K\n" +
	"\x0egroup_override\x18\x01 \x01(\v2\x1c.sourcemod.v1.GroupOverridesB\x06\xbaH\x03\xc8\x01\x01R\rgroupOverride\"\xbb\x02\n" +
	"\x18EditGroupOverrideRequest\x12%\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\x126\n" +
	"\x11group_override_id\x18\x02 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\x0fgroupOverrideId\x12\x1e\n" +
	"\x04name\x18\x03 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12L\n" +
	"\roverride_type\x18\x04 \x01(\x0e2\x1a.sourcemod.v1.OverrideTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\foverrideType\x12R\n" +
	"\x0foverride_access\x18\x05 \x01(\x0e2\x1c.sourcemod.v1.OverrideAccessB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x0eoverrideAccess\"h\n" +
	...
	"\x06admins\x18\x01 \x03(\v2\x13.sourcemod.v1.AdminB\x06\xbaH\x03\xc8\x01\x01R\x06admins\"\xfe\x01\n" +
	"\x12CreateAdminRequest\x12@\n" +
	"\tauth_type\x18\x01 \x01(\x0e2\x16.sourcemod.v1.AuthTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\bauthType\x12\"\n" +
	"\bidentity\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\bidentity\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12\x1c\n" +
	"\x05flags\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05flags\x12\x1e\n" +
	...
	"\x05flags\x18\x05 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05flags\x12\x1e\n" +
	...
	"\toverrides\x18\x01 \x03(\v2\x16.sourcemod.v1.OverrideB\x06\xbaH\x03\xc8\x01\x01R\toverrides\"\xa4\x01\n" +
	"\x16CreateOverridesRequest\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12L\n" +
	"\roverride_type\x18\x02 \x01(\x0e2\x1a.sourcemod.v1.OverrideTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\foverrideType\x12\x1c\n" +
	"\x05flags\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05flags\"U\n" +
	"\x17CreateOverridesResponse\x12:\n" +
	"\boverride\x18\x01 \x01(\v2\x16.sourcemod.v1.OverrideB\x06\xbaH\x03\xc8\x01\x01R\boverride\"\xcf\x01\n" +
	"\x14EditOverridesRequest\x12+\n" +
	"\voverride_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\n" +
	"overrideId\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12L\n" +
	"\roverride_type\x18\x03 \x01(\x0e2\x1a.sourcemod.v1.OverrideTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\foverrideType\x12\x1c\n" +
	"\x05flags\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x05flags\"S\n" +
	"\x15EditOverridesResponse\x12:\n" +
	"\boverride\x18\x01 \x01(\v2\x16.sourcemod.v1.OverrideB\x06\xbaH\x03\xc8\x01\x01R\boverride\"E\n" +
	"\x16DeleteOverridesRequest\x12+\n" +
	"\voverride_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\n" +
	"overrideId\"i\n" +
	"\x17GroupImmunitiesResponse\x12N\n" +
	"\x10group_immunities\x18\x01 \x03(\v2\x1b.sourcemod.v1.GroupImmunityB\x06\xbaH\x03\xc8\x01\x01R\x0fgroupImmunities\"e\n" +
	"\x15CreateImmunityRequest\x12%\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\x12%\n" +
	"\bother_id\x18\x02 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\aotherId\"d\n" +
	...
	"immunityId\"\xf0\x01\n" +
	"\rGroupImmunity\x126\n" +
	"\x11group_immunity_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\x0fgroupImmunityId\x121\n" +
	...
	"\n" +
	"created_on\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedOn\"\xb3\x03\n" +
	"\x0eGroupOverrides\x122\n" +
	"\x11group_override_id\x18\x01 \x01(\x05B\x06\xbaH\x03\xc8\x01\x01R\x0fgroupOverrideId\x12%\n" +
	"\bgroup_id\x18\x02 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\agroupId\x12L\n" +
	"\roverride_type\x18\x03 \x01(\x0e2\x1a.sourcemod.v1.OverrideTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\foverrideType\x12\x1e\n" +
	"\x04name\x18\x04 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12R\n" +
	"\x0foverride_access\x18\x05 \x01(\x0e2\x1c.sourcemod.v1.OverrideAccessB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x0eoverrideAccess\x12A\n" +
	"\n" +
	"created_on\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedOn\x12A\n" +
	"\n" +
	"updated_on\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn\"\xed\x03\n" +
	"\x05Admin\x12%\n" +
	"\badmin_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\aadminId\x12!\n" +
	"\bsteam_id\x18\x02 \x01(\x03B\x06\xbaH\x03\xc8\x01\x01R\asteamId\x126\n" +
	...
	"\n" +
	"updated_on\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn\"\xc5\x02\n" +
	"\bOverride\x12+\n" +
	"\voverride_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\n" +
	"overrideId\x12L\n" +
	"\roverride_type\x18\x02 \x01(\x0e2\x1a.sourcemod.v1.OverrideTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\foverrideType\x12\x1a\n" +
...
var file_sourcemod_v1_sourcemod_proto_depIdxs = []int32{
	...
	3,  // 32: sourcemod.v1.Admin.groups:type_name -> sourcemod.v1.Group
	41, // 33: sourcemod.v1.Admin.created_on:type_name -> google.protobuf.Timestamp
	41, // 34: sourcemod.v1.Admin.updated_on:type_name -> google.protobuf.Timestamp
	0,  // 35: sourcemod.v1.Override.override_type:type_name -> sourcemod.v1.OverrideType
	41, // 36: sourcemod.v1.Override.created_on:type_name -> google.protobuf.Timestamp
	41, // 37: sourcemod.v1.Override.updated_on:type_name -> google.protobuf.Timestamp
	42, // 38: sourcemod.v1.SourcemodService.Groups:input_type -> google.protobuf.Empty
	5,  // 39: sourcemod.v1.SourcemodService.CreateGroup:input_type -> sourcemod.v1.CreateGroupRequest
	7,  // 40: sourcemod.v1.SourcemodService.EditGroups:input_type -> sourcemod.v1.EditGroupsRequest
	9,  // 41: sourcemod.v1.SourcemodService.DeleteGroup:input_type -> sourcemod.v1.DeleteGroupRequest
	10, // 42: sourcemod.v1.SourcemodService.GroupOverrides:input_type -> sourcemod.v1.GroupOverridesRequest
	12, // 43: sourcemod.v1.SourcemodService.CreateGroupOverride:input_type -> sourcemod.v1.CreateGroupOverrideRequest
	14, // 44: sourcemod.v1.SourcemodService.EditGroupOverride:input_type -> sourcemod.v1.EditGroupOverrideRequest
	16, // 45: sourcemod.v1.SourcemodService.DeleteGroupOverride:input_type -> sourcemod.v1.DeleteGroupOverrideRequest
	42, // 46: sourcemod.v1.SourcemodService.Admins:input_type -> google.protobuf.Empty
	19, // 47: sourcemod.v1.SourcemodService.CreateAdmin:input_type -> sourcemod.v1.CreateAdminRequest
	21, // 48: sourcemod.v1.SourcemodService.EditAdmin:input_type -> sourcemod.v1.EditAdminRequest
	23, // 49: sourcemod.v1.SourcemodService.DeleteAdmin:input_type -> sourcemod.v1.DeleteAdminRequest
	24, // 50: sourcemod.v1.SourcemodService.AddAdminGroup:input_type -> sourcemod.v1.AddAdminGroupRequest
	26, // 51: sourcemod.v1.SourcemodService.DeleteAdminGroup:input_type -> sourcemod.v1.DeleteAdminGroupRequest
	42, // 52: sourcemod.v1.SourcemodService.Overrides:input_type -> google.protobuf.Empty
	28, // 53: sourcemod.v1.SourcemodService.CreateOverrides:input_type -> sourcemod.v1.CreateOverridesRequest
	30, // 54: sourcemod.v1.SourcemodService.EditOverrides:input_type -> sourcemod.v1.EditOverridesRequest
	32, // 55: sourcemod.v1.SourcemodService.DeleteOverrides:input_type -> sourcemod.v1.DeleteOverridesRequest
	42, // 56: sourcemod.v1.SourcemodService.GroupImmunities:input_type -> google.protobuf.Empty
	34, // 57: sourcemod.v1.SourcemodService.CreateImmunity:input_type -> sourcemod.v1.CreateImmunityRequest
	36, // 58: sourcemod.v1.SourcemodService.DeleteImmunity:input_type -> sourcemod.v1.DeleteImmunityRequest
	4,  // 59: sourcemod.v1.SourcemodService.Groups:output_type -> sourcemod.v1.GroupsResponse
	6,  // 60: sourcemod.v1.SourcemodService.CreateGroup:output_type -> sourcemod.v1.CreateGroupResponse
	8,  // 61: sourcemod.v1.SourcemodService.EditGroups:output_type -> sourcemod.v1.EditGroupsResponse
	42, // 62: sourcemod.v1.SourcemodService.DeleteGroup:output_type -> google.protobuf.Empty
	11, // 63: sourcemod.v1.SourcemodService.GroupOverrides:output_type -> sourcemod.v1.GroupOverridesResponse
	13, // 64: sourcemod.v1.SourcemodService.CreateGroupOverride:output_type -> sourcemod.v1.CreateGroupOverrideResponse
	15, // 65: sourcemod.v1.SourcemodService.EditGroupOverride:output_type -> sourcemod.v1.EditGroupOverrideResponse
	42, // 66: sourcemod.v1.SourcemodService.DeleteGroupOverride:output_type -> google.protobuf.Empty
	18, // 67: sourcemod.v1.SourcemodService.Admins:output_type -> sourcemod.v1.AdminsResponse
	20, // 68: sourcemod.v1.SourcemodService.CreateAdmin:output_type -> sourcemod.v1.CreateAdminResponse
	22, // 69: sourcemod.v1.SourcemodService.EditAdmin:output_type -> sourcemod.v1.EditAdminResponse
	42, // 70: sourcemod.v1.SourcemodService.DeleteAdmin:output_type -> google.protobuf.Empty
	25, // 71: sourcemod.v1.SourcemodService.AddAdminGroup:output_type -> sourcemod.v1.AddAdminGroupResponse
	42, // 72: sourcemod.v1.SourcemodService.DeleteAdminGroup:output_type -> google.protobuf.Empty
	27, // 73: sourcemod.v1.SourcemodService.Overrides:output_type -> sourcemod.v1.OverridesResponse
	29, // 74: sourcemod.v1.SourcemodService.CreateOverrides:output_type -> sourcemod.v1.CreateOverridesResponse
	31, // 75: sourcemod.v1.SourcemodService.EditOverrides:output_type -> sourcemod.v1.EditOverridesResponse
	42, // 76: sourcemod.v1.SourcemodService.DeleteOverrides:output_type -> google.protobuf.Empty
	33, // 77: sourcemod.v1.SourcemodService.GroupImmunities:output_type -> sourcemod.v1.GroupImmunitiesResponse
	35, // 78: sourcemod.v1.SourcemodService.CreateImmunity:output_type -> sourcemod.v1.CreateImmunityResponse
	42, // 79: sourcemod.v1.SourcemodService.DeleteImmunity:output_type -> google.protobuf.Empty
