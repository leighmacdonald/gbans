...
const file_sourcemod_v1_sourcemod_proto_rawDesc = "" +
	...
	"\n" +
	"updated_on\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn\"\xf7\x03\n" +
	"\x05Admin\x12%\n" +
	"\badmin_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\aadminId\x12!\n" +
	"\bsteam_id\x18\x02 \x01(\x03B\x06\xbaH\x03\xc8\x01\x01R\asteamId\x12@\n" +
	"\tauth_type\x18\x03 \x01(\x0e2\x16.sourcemod.v1.AuthTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\bauthType\x12\"\n" +
