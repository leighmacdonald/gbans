...
const file_sourcemod_v1_plugin_proto_rawDesc = "" +
	...
	"\x04name\x18\x04 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18 R\x04name\"\x84\x01\n" +
	"\x0fSMCheckResponse\x12#\n" +
	"\tclient_id\x18\x01 \x01(\x05B\x06\xbaH\x03\xc8\x01\x01R\bclientId\x122\n" +
	"\bban_type\x18\x02 \x01(\x0e2\x0f.ban.v1.BanTypeB\x06\xbaH\x03\xc8\x01\x01R\abanType\x12\x18\n" +
