...
func (x *CheckBlockRequest) Reset() {
	*x = CheckBlockRequest{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CheckBlockRequest) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{10}
}
...
func (x *CheckBlockResponse) Reset() {
	*x = CheckBlockResponse{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CheckBlockResponse) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{11}
}
...
func (x *BlocklistSourcesDeleteRequest) Reset() {
	*x = BlocklistSourcesDeleteRequest{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlocklistSourcesDeleteRequest) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{12}
}
...
func (x *BlocklistSourcesEditRequest) Reset() {
	*x = BlocklistSourcesEditRequest{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlocklistSourcesEditRequest) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{13}
}
...
func (x *BlocklistSourcesEditResponse) Reset() {
	*x = BlocklistSourcesEditResponse{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlocklistSourcesEditResponse) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{14}
}
...
func (x *BlocklistSourcesCreateRequest) Reset() {
	*x = BlocklistSourcesCreateRequest{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlocklistSourcesCreateRequest) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{15}
}
...
func (x *BlocklistSourcesCreateResponse) Reset() {
	*x = BlocklistSourcesCreateResponse{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlocklistSourcesCreateResponse) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{16}
}
...
func (x *WhitelistAddressResponse) Reset() {
	*x = WhitelistAddressResponse{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WhitelistAddressResponse) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{17}
}
...
func (x *CIDRBlockWhitelist) Reset() {
	*x = CIDRBlockWhitelist{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CIDRBlockWhitelist) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{18}
}
...
func (x *BlocklistSourcesResponse) Reset() {
	*x = BlocklistSourcesResponse{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlocklistSourcesResponse) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{19}
}
...
func (x *CIDRBlockSource) Reset() {
	*x = CIDRBlockSource{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CIDRBlockSource) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{20}
}
...
func (x *WhitelistIP) Reset() {
	*x = WhitelistIP{}
	mi := &file_blocklist_v1_blocklist_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WhitelistIP) Descriptor() ([]byte, []int) {
	return file_blocklist_v1_blocklist_proto_rawDescGZIP(), []int{21}
}
...
const file_blocklist_v1_blocklist_proto_rawDesc = "" +
	"\n" +
	"\x1cblocklist/v1/blocklist.proto\x12\fblocklist.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"N\n" +
	"\x1bWhitelistSteamCreateRequest\x12/\n" +
	"\bsteam_id\x18\x01 \x01(\x03B\x14\xbaH\x0f\xc8\x01\x01\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x010\x01R\asteamId\"b\n" +
	"\x1cWhitelistSteamCreateResponse\x12B\n" +
	"\twhitelist\x18\x01 \x01(\v2\x1c.blocklist.v1.WhitelistSteamB\x06\xbaH\x03\xc8\x01\x01R\twhitelist\"N\n" +
	"\x1bWhitelistSteamDeleteRequest\x12/\n" +
	"\bsteam_id\x18\x01 \x01(\x03B\x14\xbaH\x0f\xc8\x01\x01\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x010\x01R\asteamId\"^\n" +
	"\x16WhitelistSteamResponse\x12D\n" +
	"\n" +
	"whitelists\x18\x01 \x03(\v2\x1c.blocklist.v1.WhitelistSteamB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"whitelists\"\x9b\x02\n" +
	...
	"\aaddress\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\aaddress\"_\n" +
	"\x1cWhitelistAddressEditResponse\x12?\n" +
	"\twhitelist\x18\x01 \x01(\v2\x19.blocklist.v1.WhitelistIPB\x06\xbaH\x03\xc8\x01\x01R\twhitelist\"^\n" +
	...
	"\aaddress\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\aaddress\"h\n" +
	"\x1eWhitelistAddressCreateResponse\x12F\n" +
	"\twhitelist\x18\x01 \x01(\v2 .blocklist.v1.CIDRBlockWhitelistB\x06\xbaH\x03\xc8\x01\x01R\twhitelist\"9\n" +
	"\x11CheckBlockRequest\x12$\n" +
	"\aaddress\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02x\x01R\aaddress\"V\n" +
	...
	"\aenabled\x18\x04 \x01(\bB\x06\xbaH\x03\xc8\x01\x01R\aenabled\"h\n" +
	"\x1cBlocklistSourcesEditResponse\x12H\n" +
	"\fblock_source\x18\x01 \x01(\v2\x1d.blocklist.v1.CIDRBlockSourceB\x06\xbaH\x03\xc8\x01\x01R\vblockSource\"w\n" +
	...
	"\aenabled\x18\x03 \x01(\bB\x06\xbaH\x03\xc8\x01\x01R\aenabled\"j\n" +
	"\x1eBlocklistSourcesCreateResponse\x12H\n" +
	"\fblock_source\x18\x01 \x01(\v2\x1d.blocklist.v1.CIDRBlockSourceB\x06\xbaH\x03\xc8\x01\x01R\vblockSource\"f\n" +
	"\x18WhitelistAddressResponse\x12J\n" +
	"\vwhitelisted\x18\x01 \x03(\v2 .blocklist.v1.CIDRBlockWhitelistB\x06\xbaH\x03\xc8\x01\x01R\vwhitelisted\"\xfb\x01\n" +
	...
	"\n" +
	"updated_on\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn\"l\n" +
	"\x18BlocklistSourcesResponse\x12P\n" +
	"\x10blocklist_source\x18\x01 \x03(\v2\x1d.blocklist.v1.CIDRBlockSourceB\x06\xbaH\x03\xc8\x01\x01R\x0fblocklistSource\"\xb5\x02\n" +
	"\x0fCIDRBlockSource\x12;\n" +
	"\x14cidr_block_source_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\x11cidrBlockSourceId\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x04name\x12\x1d\n" +
	"\x03url\x18\x03 \x01(\tB\v\xbaH\b\xc8\x01\x01r\x03\x88\x01\x01R\x03url\x12 \n" +
	...
	"\n" +
	"updated_on\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn\"\xfd\x01\n" +
	"\vWhitelistIP\x12A\n" +
	"\x17cidr_block_whitelist_id\x18\x01 \x01(\x05B\n" +
	"\xbaH\a\xc8\x01\x01\x1a\x02 \x00R\x14cidrBlockWhitelistId\x12%\n" +
	"\aaddress\x18\x02 \x01(\tB\v\xbaH\b\xc8\x01\x01r\x03\xd8\x01\x01R\aaddress\x12A\n" +
	"\n" +
	"created_on\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedOn\x12A\n" +
	"\n" +
	"updated_on\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn2\xc3\t\n" +
	"\x10BlocklistService\x12T\n" +
	"\x10BlocklistSources\x12\x16.google.protobuf.Empty\x1a&.blocklist.v1.BlocklistSourcesResponse\"\x00\x12u\n" +
	"\x16BlocklistSourcesCreate\x12+.blocklist.v1.BlocklistSourcesCreateRequest\x1a,.blocklist.v1.BlocklistSourcesCreateResponse\"\x00\x12o\n" +
	"\x14BlocklistSourcesEdit\x12).blocklist.v1.BlocklistSourcesEditRequest\x1a*.blocklist.v1.BlocklistSourcesEditResponse\"\x00\x12_\n" +
	"\x16BlocklistSourcesDelete\x12+.blocklist.v1.BlocklistSourcesDeleteRequest\x1a\x16.google.protobuf.Empty\"\x00\x12T\n" +
	"\x10WhitelistAddress\x12\x16.google.protobuf.Empty\x1a&.blocklist.v1.WhitelistAddressResponse\"\x00\x12u\n" +
	"\x16WhitelistAddressCreate\x12+.blocklist.v1.WhitelistAddressCreateRequest\x1a,.blocklist.v1.WhitelistAddressCreateResponse\"\x00\x12_\n" +
	"\x16WhitelistAddressDelete\x12+.blocklist.v1.WhitelistAddressDeleteRequest\x1a\x16.google.protobuf.Empty\"\x00\x12o\n" +
	"\x14WhitelistAddressEdit\x12).blocklist.v1.WhitelistAddressEditRequest\x1a*.blocklist.v1.WhitelistAddressEditResponse\"\x00\x12P\n" +
	"\x0eWhitelistSteam\x12\x16.google.protobuf.Empty\x1a$.blocklist.v1.WhitelistSteamResponse\"\x00\x12[\n" +
	"\x14WhitelistSteamDelete\x12).blocklist.v1.WhitelistSteamDeleteRequest\x1a\x16.google.protobuf.Empty\"\x00\x12o\n" +
	"\x14WhitelistSteamCreate\x12).blocklist.v1.WhitelistSteamCreateRequest\x1a*.blocklist.v1.WhitelistSteamCreateResponse\"\x00\x12Q\n" +
	"\n" +
	"CheckBlock\x12\x1f.blocklist.v1.CheckBlockRequest\x1a .blocklist.v1.CheckBlockResponse\"\x00B\xb6\x01\n" +
	"\x10com.blocklist.v1B\x0eBlocklistProtoP\x01ZAgithub.com/leighmacdonald/gbans/internal/blocklist/v1;blocklistv1\xa2\x02\x03BXX\xaa\x02\fBlocklist.V1\xca\x02\fBlocklist\\V1\xe2\x02\x18Blocklist\\V1\\GPBMetadata\xea\x02\rBlocklist::V1b\beditionsp\xe8\a"
...
var file_blocklist_v1_blocklist_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_blocklist_v1_blocklist_proto_goTypes = []any{
	(*WhitelistSteamCreateRequest)(nil),    // 0: blocklist.v1.WhitelistSteamCreateRequest
	(*WhitelistSteamCreateResponse)(nil),   // 1: blocklist.v1.WhitelistSteamCreateResponse
	(*WhitelistSteamDeleteRequest)(nil),    // 2: blocklist.v1.WhitelistSteamDeleteRequest
	(*WhitelistSteamResponse)(nil),         // 3: blocklist.v1.WhitelistSteamResponse
	(*WhitelistSteam)(nil),                 // 4: blocklist.v1.WhitelistSteam
	(*WhitelistAddressEditRequest)(nil),    // 5: blocklist.v1.WhitelistAddressEditRequest
	(*WhitelistAddressEditResponse)(nil),   // 6: blocklist.v1.WhitelistAddressEditResponse
	(*WhitelistAddressDeleteRequest)(nil),  // 7: blocklist.v1.WhitelistAddressDeleteRequest
	(*WhitelistAddressCreateRequest)(nil),  // 8: blocklist.v1.WhitelistAddressCreateRequest
	(*WhitelistAddressCreateResponse)(nil), // 9: blocklist.v1.WhitelistAddressCreateResponse
	(*CheckBlockRequest)(nil),              // 10: blocklist.v1.CheckBlockRequest
	(*CheckBlockResponse)(nil),             // 11: blocklist.v1.CheckBlockResponse
	(*BlocklistSourcesDeleteRequest)(nil),  // 12: blocklist.v1.BlocklistSourcesDeleteRequest
	(*BlocklistSourcesEditRequest)(nil),    // 13: blocklist.v1.BlocklistSourcesEditRequest
	(*BlocklistSourcesEditResponse)(nil),   // 14: blocklist.v1.BlocklistSourcesEditResponse
	(*BlocklistSourcesCreateRequest)(nil),  // 15: blocklist.v1.BlocklistSourcesCreateRequest
	(*BlocklistSourcesCreateResponse)(nil), // 16: blocklist.v1.BlocklistSourcesCreateResponse
	(*WhitelistAddressResponse)(nil),       // 17: blocklist.v1.WhitelistAddressResponse
	(*CIDRBlockWhitelist)(nil),             // 18: blocklist.v1.CIDRBlockWhitelist
	(*BlocklistSourcesResponse)(nil),       // 19: blocklist.v1.BlocklistSourcesResponse
	(*CIDRBlockSource)(nil),                // 20: blocklist.v1.CIDRBlockSource
	(*WhitelistIP)(nil),                    // 21: blocklist.v1.WhitelistIP
	(*timestamppb.Timestamp)(nil),          // 22: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                  // 23: google.protobuf.Empty
}
var file_blocklist_v1_blocklist_proto_depIdxs = []int32{
	4,  // 0: blocklist.v1.WhitelistSteamCreateResponse.whitelist:type_name -> blocklist.v1.WhitelistSteam
	4,  // 1: blocklist.v1.WhitelistSteamResponse.whitelists:type_name -> blocklist.v1.WhitelistSteam
	22, // 2: blocklist.v1.WhitelistSteam.created_on:type_name -> google.protobuf.Timestamp
	22, // 3: blocklist.v1.WhitelistSteam.updated_on:type_name -> google.protobuf.Timestamp
	21, // 4: blocklist.v1.WhitelistAddressEditResponse.whitelist:type_name -> blocklist.v1.WhitelistIP
	18, // 5: blocklist.v1.WhitelistAddressCreateResponse.whitelist:type_name -> blocklist.v1.CIDRBlockWhitelist
	20, // 6: blocklist.v1.BlocklistSourcesEditResponse.block_source:type_name -> blocklist.v1.CIDRBlockSource
	20, // 7: blocklist.v1.BlocklistSourcesCreateResponse.block_source:type_name -> blocklist.v1.CIDRBlockSource
	18, // 8: blocklist.v1.WhitelistAddressResponse.whitelisted:type_name -> blocklist.v1.CIDRBlockWhitelist
	22, // 9: blocklist.v1.CIDRBlockWhitelist.created_on:type_name -> google.protobuf.Timestamp
	22, // 10: blocklist.v1.CIDRBlockWhitelist.updated_on:type_name -> google.protobuf.Timestamp
	20, // 11: blocklist.v1.BlocklistSourcesResponse.blocklist_source:type_name -> blocklist.v1.CIDRBlockSource
	22, // 12: blocklist.v1.CIDRBlockSource.created_on:type_name -> google.protobuf.Timestamp
	22, // 13: blocklist.v1.CIDRBlockSource.updated_on:type_name -> google.protobuf.Timestamp
	22, // 14: blocklist.v1.WhitelistIP.created_on:type_name -> google.protobuf.Timestamp
	22, // 15: blocklist.v1.WhitelistIP.updated_on:type_name -> google.protobuf.Timestamp
	23, // 16: blocklist.v1.BlocklistService.BlocklistSources:input_type -> google.protobuf.Empty
	15, // 17: blocklist.v1.BlocklistService.BlocklistSourcesCreate:input_type -> blocklist.v1.BlocklistSourcesCreateRequest
	13, // 18: blocklist.v1.BlocklistService.BlocklistSourcesEdit:input_type -> blocklist.v1.BlocklistSourcesEditRequest
	12, // 19: blocklist.v1.BlocklistService.BlocklistSourcesDelete:input_type -> blocklist.v1.BlocklistSourcesDeleteRequest
	23, // 20: blocklist.v1.BlocklistService.WhitelistAddress:input_type -> google.protobuf.Empty
	8,  // 21: blocklist.v1.BlocklistService.WhitelistAddressCreate:input_type -> blocklist.v1.WhitelistAddressCreateRequest
	7,  // 22: blocklist.v1.BlocklistService.WhitelistAddressDelete:input_type -> blocklist.v1.WhitelistAddressDeleteRequest
	5,  // 23: blocklist.v1.BlocklistService.WhitelistAddressEdit:input_type -> blocklist.v1.WhitelistAddressEditRequest
	23, // 24: blocklist.v1.BlocklistService.WhitelistSteam:input_type -> google.protobuf.Empty
	2,  // 25: blocklist.v1.BlocklistService.WhitelistSteamDelete:input_type -> blocklist.v1.WhitelistSteamDeleteRequest
	0,  // 26: blocklist.v1.BlocklistService.WhitelistSteamCreate:input_type -> blocklist.v1.WhitelistSteamCreateRequest
	10, // 27: blocklist.v1.BlocklistService.CheckBlock:input_type -> blocklist.v1.CheckBlockRequest
	19, // 28: blocklist.v1.BlocklistService.BlocklistSources:output_type -> blocklist.v1.BlocklistSourcesResponse
	16, // 29: blocklist.v1.BlocklistService.BlocklistSourcesCreate:output_type -> blocklist.v1.BlocklistSourcesCreateResponse
	14, // 30: blocklist.v1.BlocklistService.BlocklistSourcesEdit:output_type -> blocklist.v1.BlocklistSourcesEditResponse
	23, // 31: blocklist.v1.BlocklistService.BlocklistSourcesDelete:output_type -> google.protobuf.Empty
	17, // 32: blocklist.v1.BlocklistService.WhitelistAddress:output_type -> blocklist.v1.WhitelistAddressResponse
	9,  // 33: blocklist.v1.BlocklistService.WhitelistAddressCreate:output_type -> blocklist.v1.WhitelistAddressCreateResponse
	23, // 34: blocklist.v1.BlocklistService.WhitelistAddressDelete:output_type -> google.protobuf.Empty
	6,  // 35: blocklist.v1.BlocklistService.WhitelistAddressEdit:output_type -> blocklist.v1.WhitelistAddressEditResponse
	3,  // 36: blocklist.v1.BlocklistService.WhitelistSteam:output_type -> blocklist.v1.WhitelistSteamResponse
	23, // 37: blocklist.v1.BlocklistService.WhitelistSteamDelete:output_type -> google.protobuf.Empty
	1,  // 38: blocklist.v1.BlocklistService.WhitelistSteamCreate:output_type -> blocklist.v1.WhitelistSteamCreateResponse
	11, // 39: blocklist.v1.BlocklistService.CheckBlock:output_type -> blocklist.v1.CheckBlockResponse
