...
type APIProvider interface {
	SteamGroup(ctx context.Context, groupID steamid.SteamID) (SteamGroup, error)
	LogsTFSummary(ctx context.Context, steamID steamid.SteamID) (LogsTFPlayerSummary, error)
	SteamBans(ctx context.Context, steamIDs steamid.Collection) ([]SteamBan, error)
	Summaries(ctx context.Context, steamIDs steamid.Collection) ([]PlayerSummaryResponse, error)
	Friends(ctx context.Context, steamID steamid.SteamID) ([]SteamFriend, error)
}
...
func (c TFAPI) SteamGroup(ctx context.Context, groupID steamid.SteamID) (SteamGroup, error) {
	steamGroupResp, errResp := c.SteamGroupWithResponse(ctx, &SteamGroupParams{
...
func (c TFAPI) LogsTFSummary(ctx context.Context, steamID steamid.SteamID) (LogsTFPlayerSummary, error) {
	summaryResp, errSummary := c.LogstfPlayerSummaryWithResponse(ctx, &LogstfPlayerSummaryParams{
...
func (c TFAPI) MetaProfile(ctx context.Context, steamIDs steamid.Collection) ([]MetaProfile, error) {
	resp, errResp := c.MetaProfileWithResponse(ctx, &MetaProfileParams{
...
func (c TFAPI) SteamBans(ctx context.Context, steamIDs steamid.Collection) ([]SteamBan, error) {
	resp, errResp := c.SteamBansWithResponse(ctx, &SteamBansParams{
		Steamids: strings.Join(steamIDs.ToStringSlice(), ","),
	})
	if errResp != nil {
		return nil, errResp
...
func (c TFAPI) Summaries(ctx context.Context, steamIDs steamid.Collection) ([]PlayerSummaryResponse, error) {
	resp, errResp := c.SteamSummariesWithResponse(ctx, &SteamSummariesParams{
		Steamids: strings.Join(steamIDs.ToStringSlice(), ","),
	})
	if errResp != nil {
		return nil, errResp
...
func (c TFAPI) Friends(ctx context.Context, steamID steamid.SteamID) ([]SteamFriend, error) {
	resp, errResp := c.SteamFriendsWithResponse(ctx, &SteamFriendsParams{Steamid: steamID.String()})
	if errResp != nil {
		return nil, errResp
	}
