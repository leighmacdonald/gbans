...
type LogsTFChat struct {
	...
	// IsFlagged Whether the message is a slur
...
type LogstfChatQueryParams struct {
	...
	// Query Query a messages content
	Query string `form:"query,omitempty" json:"query,omitempty"`

	// FlaggedOnly Restrict results to flagged messages
	FlaggedOnly bool `form:"flagged_only,omitempty" json:"flagged_only,omitempty"`

	// Name Restrict results to the specified name
	Name string `form:"name,omitempty" json:"name,omitempty"`

	// LogId Restrict results to the specified log ID
	LogId int64 `form:"log_id,omitempty" json:"log_id,omitempty"`
	...
	// Before Before timestamp for pagination
	Before time.Time `form:"before,omitempty" json:"before,omitempty"`

	// After After timestamp for pagination
...
func NewLogstfChatQueryRequest(server string, params *LogstfChatQueryParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if queryFrag, err := runtime.StyleParamWithLocation("form", false, "flagged_only", runtime.ParamLocationQuery, params.FlaggedOnly); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
		...
		if queryFrag, err := runtime.StyleParamWithLocation("form", false, "log_id", runtime.ParamLocationQuery, params.LogId); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
		...
		if queryFrag, err := runtime.StyleParamWithLocation("form", false, "before", runtime.ParamLocationQuery, params.Before); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
