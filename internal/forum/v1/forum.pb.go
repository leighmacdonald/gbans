...
const file_forum_v1_forum_proto_rawDesc = "" +
	...
	"\athreads\x18\x01 \x03(\v2\x1a.forum.v1.ThreadWithSourceB\x06\xbaH\x03\xc8\x01\x01R\athreads\"\xb0\x03\n" +
	"\x06Thread\x12!\n" +
	...
	"\tsource_id\x18\x03 \x01(\x03B\x12\xbaH\x0f\xc8\x01\x01\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x01R\bsourceId\x12\x1c\n" +
	...
	"\n" +
	"updated_on\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedOn\"\xfc\x03\n" +
	...
	"avatarHash\x12L\n" +
	"\x10permission_level\x18\x04 \x01(\x0e2\x14.person.v1.PrivilegeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x0fpermissionLevel\x125\n" +
	"\x17recent_forum_message_id\x18\x05 \x01(\x03R\x14recentForumMessageId\x12F\n" +
	"\x11recent_created_on\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0frecentCreatedOn\x127\n" +
	"\x0frecent_steam_id\x18\a \x01(\x03B\x0f\xbaH\f\"\n" +
	"(\x81\x80\x80\x80\x90\x80\x80\x88\x01R\rrecentSteamId\x12.\n" +
	"\x13recent_persona_name\x18\b \x01(\tR\x11recentPersonaName\x12,\n" +
	"\x12recent_avatar_hash\x18\t \x01(\tR\x10recentAvatarHash\"\xf9\x01\n" +
	"\fUserActivity\x12-\n" +
	...
	"\ruser_activity\x18\x01 \x03(\v2\x16.forum.v1.UserActivityB\x06\xbaH\x03\xc8\x01\x01R\fuserActivity\"\xd4\x04\n" +
	"\aMessage\x124\n" +
	"\x10forum_message_id\x18\x01 \x01(\x03B\n" +
	"\xbaH\a\xc8\x01\x01\"\x02 \x00R\x0eforumMessageId\x122\n" +
