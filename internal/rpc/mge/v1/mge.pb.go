...
func (x *GetRatingsOverallRequest) GetFilter() *rpc.Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *GetHistoryRequest) GetFilter() *rpc.Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
const file_mge_v1_mge_proto_rawDesc = "" +
	...
	"\n" +
	"GetHistory\x12\x19.mge.v1.GetHistoryRequest\x1a\x1a.mge.v1.GetHistoryResponseB\x8a\x01\n" +
	"\n" +
	"com.mge.v1B\bMgeProtoP\x01Z9github.com/leighmacdonald/gbans/internal/rpc/mge/v1;mgev1\xa2\x02\x03MXX\xaa\x02\x06Mge.V1\xca\x02\x06Mge\\V1\xe2\x02\x12Mge\\V1\\GPBMetadata\xea\x02\aMge::V1b\beditionsp\xe8\a"
