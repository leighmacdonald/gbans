...
type ForumEditRequest struct {
	...
	PermissionLevel *rpc.Privilege         `protobuf:"varint,3,opt,name=permission_level,json=permissionLevel,enum=Privilege" json:"permission_level,omitempty"`
...
func (x *ForumEditRequest) GetPermissionLevel() rpc.Privilege {
...
func (x *ForumCreateRequest) GetPermissionLevel() rpc.Privilege {
	if x != nil && x.PermissionLevel != nil {
		return *x.PermissionLevel
	}
	return rpc.Privilege(0)
...
func (x *ThreadWithSource) GetPermissionLevel() rpc.Privilege {
	if x != nil && x.PermissionLevel != nil {
		return *x.PermissionLevel
	}
	return rpc.Privilege(0)
...
func (x *UserActivity) GetPermissionLevel() rpc.Privilege {
	if x != nil && x.PermissionLevel != nil {
		return *x.PermissionLevel
	}
	return rpc.Privilege(0)
...
type Message struct {
	...
	PermissionLevel *rpc.Privilege         `protobuf:"varint,10,opt,name=permission_level,json=permissionLevel,enum=Privilege" json:"permission_level,omitempty"`
...
func (x *Message) GetPermissionLevel() rpc.Privilege {
	if x != nil && x.PermissionLevel != nil {
		return *x.PermissionLevel
	}
	return rpc.Privilege(0)
...
type Forum struct {
	...
	PermissionLevel     *rpc.Privilege         `protobuf:"varint,9,opt,name=permission_level,json=permissionLevel,enum=Privilege" json:"permission_level,omitempty"`
...
func (x *Forum) GetPermissionLevel() rpc.Privilege {
	if x != nil && x.PermissionLevel != nil {
		return *x.PermissionLevel
	}
	return rpc.Privilege(0)
...
const file_forum_v1_forum_proto_rawDesc = "" +
	...
	"\tForumEdit\x12\x1a.forum.v1.ForumEditRequest\x1a\x1b.forum.v1.ForumEditResponse\"\x00B\x9a\x01\n" +
	"\fcom.forum.v1B\n" +
	"ForumProtoP\x01Z=github.com/leighmacdonald/gbans/internal/rpc/forum/v1;forumv1\xa2\x02\x03FXX\xaa\x02\bForum.V1\xca\x02\bForum\\V1\xe2\x02\x14Forum\\V1\\GPBMetadata\xea\x02\tForum::V1b\beditionsp\xe8\a"
