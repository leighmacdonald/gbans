...
func (x *ReportMessage) GetPermissionLevel() rpc.Privilege {
...
type ReportWithAuthor struct {
	...
	Author        *rpc.PersonCore        `protobuf:"bytes,2,opt,name=author" json:"author,omitempty"`
	Subject       *rpc.PersonCore        `protobuf:"bytes,3,opt,name=subject" json:"subject,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReportWithAuthor) GetAuthor() *rpc.PersonCore {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *ReportWithAuthor) GetSubject() *rpc.PersonCore {
	if x != nil {
		return x.Subject
	}
	return nil
...
const file_ban_v1_report_proto_rawDesc = "" +
	...
	"\x13ReportMessageDelete\x12\".ban.v1.ReportMessageDeleteRequest\x1a\x16.google.protobuf.Empty\"\x00B\x8d\x01\n" +
	"\n" +
	"com.ban.v1B\vReportProtoP\x01Z9github.com/leighmacdonald/gbans/internal/rpc/ban/v1;banv1\xa2\x02\x03BXX\xaa\x02\x06Ban.V1\xca\x02\x06Ban\\V1\xe2\x02\x12Ban\\V1\\GPBMetadata\xea\x02\aBan::V1b\beditionsp\xe8\a"
...
var file_ban_v1_report_proto_goTypes = []any{
	...
	(rpc.Privilege)(0),                  // 19: Privilege
	(BanReason)(0),                      // 20: ban.v1.BanReason
	(*rpc.PersonCore)(nil),              // 21: PersonCore
