...
func (x *QueryNetworkRequest) GetFilter() *rpc.Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *QueryConnectionsRequest) GetFilter() *rpc.Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
const file_network_v1_network_proto_rawDesc = "" +
	...
	"\bUpdateDB\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00B\xaa\x01\n" +
	"\x0ecom.network.v1B\fNetworkProtoP\x01ZAgithub.com/leighmacdonald/gbans/internal/rpc/network/v1;networkv1\xa2\x02\x03NXX\xaa\x02\n" +
	"Network.V1\xca\x02\n" +
