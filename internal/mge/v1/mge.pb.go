...
const file_mge_v1_mge_proto_rawDesc = "" +
	...
	"\bsteam_id\x18\x02 \x01(\tR\asteamId\"\xe6\x02\n" +
	"\vPlayerStats\x12!\n" +
	...
	"\x05count\x18\x02 \x01(\x03B\b\xbaH\x03\xc8\x01\x010\x01R\x05count\"\xcc\x01\n" +
	...
	"\x06loser2\x18\x06 \x01(\tR\x06loser2\"\xeb\x06\n" +
	"\x04Duel\x12\x1f\n" +
	"\aduel_id\x18\x01 \x01(\x05B\x06\xbaH\x03\xc8\x01\x01R\x06duelId\x12 \n" +
	"\x06winner\x18\x02 \x01(\x03B\b\xbaH\x03\xc8\x01\x010\x01R\x06winner\x124\n" +
	...
	"\awinner2\x18\x05 \x01(\x03B\b\xbaH\x03\xc8\x01\x010\x01R\awinner2\x126\n" +
	"\x13winner2_avatar_hash\x18\x06 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x11winner2AvatarHash\x128\n" +
	"\x14winner2_persona_name\x18\a \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x12winner2PersonaName\x12\x1e\n" +
	"\x05loser\x18\b \x01(\x03B\b\xbaH\x03\xc8\x01\x010\x01R\x05loser\x122\n" +
	...
	"\x06loser2\x18\v \x01(\x03B\b\xbaH\x03\xc8\x01\x010\x01R\x06loser2\x124\n" +
	...
	"\n" +
	"arena_name\x18\x13 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\tarenaName\"d\n" +
