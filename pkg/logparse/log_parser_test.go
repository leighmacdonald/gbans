...
func TestParseUnhandledMsgEvt(t *testing.T) {
	...
	testLogLine(t, m, IgnoredMsgEvt{
		TimeStamp: TimeStamp{CreatedOn: time.Date(2021, 02, 21, 06, 22, 23, 0, time.UTC)},
		Message:   m})
}
...
func TestParseLogStartEvt(t *testing.T) {
	testLogLine(t, `L 02/21/2021 - 06:22:23: Log file started (file "logs/L0221034.log") (game "/home/tf2server/serverfiles/tf") (version "6300758")`, LogStartEvt{
		TimeStamp: TimeStamp{CreatedOn: time.Date(2021, time.February, 21, 6, 22, 23, 0, time.UTC)},
...
func TestParseRCONEvt(t *testing.T) {
	testLogLine(t, `L 02/21/2021 - 06:22:23: rcon from "23.239.22.163:42004": command "status"`,
		RCONEvt{TimeStamp: TimeStamp{CreatedOn: time.Date(2021, time.February, 21, 6, 22, 23, 0, time.UTC)},
			Cmd: "status"})
}
...
func TestParsePointCapturedEvt(t *testing.T) {
	evt := PointCapturedEvt{
		TimeStamp: TimeStamp{CreatedOn: time.Date(2021, time.February, 21, 6, 22, 23, 0, time.UTC)},
		Team:      RED, CP: 0, CPName: "#koth_viaduct_cap", NumCappers: 2,
		Player1: "Hacksaw<12><[U:1:68745073]><Red>", Position1: Pos{X: 101, Y: 98, Z: -313},
		Player2: "El Sur<35><[U:1:423376881]><Red>", Position2: Pos{X: -95, Y: 152, Z: -767},
	}
	...
	expectedPlayers := []SourcePlayerPosition{
		{SourcePlayer: SourcePlayer{Name: "Hacksaw", PID: 12, SID: 0x11000010418f771, Team: RED}, Pos: Pos{X: 101, Y: 98, Z: -313}},
		{SourcePlayer: SourcePlayer{Name: "El Sur", PID: 35, SID: steamid.SID3ToSID64("[U:1:423376881]"), Team: RED}, Pos: Pos{X: -95, Y: 152, Z: -767}},
	}
