...
func NewWeaponParser() *WeaponParser { //nolint:maintidx
	return &WeaponParser{
		weaponNames: map[Weapon]string{
			...
			FlyingGuillotine:     "tf_projectile_cleaver",
			ForceANature:         "force_a_nature",
			FortifiedCompound:    "compound_bow",
			FrontierJustice:      "frontier_justice",
			FryingPan:            "fryingpan",
			GasPasser:            "tf_projectile_jar_gas",
			Grenade:              "tf_projectile_pipe",
			...
			RocketMangler:        "tf_projectile_energy_ball",
			Sandman:              "sandman",
			SandmanBall:          "tf_projectile_stun_ball",
			...
			ShortCircuitOrb:      "tf_projectile_mechanicalarmorb",
			ShortStop:            "shortstop",
			...
			SouthernHospitality:  "southern_comfort_kill",
