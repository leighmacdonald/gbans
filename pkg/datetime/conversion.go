...
//
// Note that this should not be used when *exact* times are required, this is just a trivial implementation
// that does not bother with irregular lengths of days. see: https://github.com/golang/go/issues/17767
