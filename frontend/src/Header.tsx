        ...
        children.push(
            <li>
                ...
                <ul className="menu vertical">
                    ...
                    <li>
                        <Link to="/admin/filters">Filtered Words</Link>
                    </li>
                    <li>
                        <Link to="/admin/servers">Servers</Link>
                    </li>
                    <li>
                        <Link to="/admin/server_logs">Server Logs</Link>
                    </li>
                </ul>
            </li>
        );
        children.push(
            <li>
                <Link to={`/profile/${currentUser.player.steam_id}`}>
                    ...
                    <span>{currentUser.player.personaname}</span>
                </Link>
                <ul className="menu vertical">
                    <li>
                    ...
                    <div className="top-bar">
                        <div className="top-bar-left">
                            <ul className="dropdown menu" data-dropdown-menu={true}>
                                ...
                                <li>
                                    <Link to={'/bans'}>
                                        <i className="fi-torsos-all" /> Bans
                                    </Link>
                                    <ul className="menu vertical">
                                        <li>
                                            <Link to="/bans">All Bans</Link>
                                        </li>
                                        <li>
