...
export const ForumCategorySelectField = () => {
    ...
    return (
        <FormControl fullWidth>
            <InputLabel id="forum_category_id-label">Forum Parent Category</InputLabel>
            <Select<number>
                fullWidth
                ...
                error={touched.forum_category_id && Boolean(errors.forum_category_id)}
                onChange={handleChange}
            >
                {categories &&
                    categories.map((s) => (
                        <MenuItem value={s.forum_category_id} key={`select-cat-${s.forum_category_id}`}>
                            {s.title}
                        </MenuItem>
                    ))}
            </Select>
