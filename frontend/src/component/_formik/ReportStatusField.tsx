...
export const ReportStatusField = <T,>() => {
    const { values, touched, errors, handleChange } = useFormikContext<T & ReportStatusFieldProps>();
    return (
        <Box>
            <FormControl fullWidth>
                ...
                <FormHelperText>{touched.report_status && errors.report_status && `${errors.report_status}`}</FormHelperText>
            </FormControl>
        </Box>
    );
};
