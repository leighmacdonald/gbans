...
export const UnbanReasonTextField = <T,>() => {
    const { values, isSubmitting, touched, errors, handleChange } = useFormikContext<T & BanReasonTextFieldProps & BanReasonFieldProps>();
    ...
    return (
        <TextField
            ...
            helperText={touched.unban_reason && errors.unban_reason && `${errors.unban_reason}`}
            variant="outlined"
        />
    );
};
