...
export const AppealStateField = <T,>() => {
    const { values, touched, errors, handleChange } = useFormikContext<T & AppealStateFieldProps>();
    return (
        <FormControl fullWidth>
            ...
            <FormHelperText>{touched.appeal_state && errors.appeal_state && `${errors.appeal_state}`}</FormHelperText>
        </FormControl>
    );
};
