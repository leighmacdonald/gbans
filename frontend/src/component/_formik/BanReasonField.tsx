...
export const BanReasonField = <T,>() => {
    const { values, touched, errors, handleChange } = useFormikContext<T & BanReasonFieldProps>();
    ...
    return (
        <FormControl fullWidth>
            ...
            <FormHelperText>{touched.reason && errors.reason && `${errors.reason}`}</FormHelperText>
        </FormControl>
    );
};
