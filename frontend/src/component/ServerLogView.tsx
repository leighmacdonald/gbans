        ...
        <div className={"grid-y grid-padding-y"}>
            <div className={"grid-x grid-padding-x"}>
                <div className={"cell auto"}>
                    <select onChange={(event: SyntheticEvent) => {
            ...
            {takeRight(entries.filter(value => filterServerIDs ? includes(serverIDs, value.ServerID)  : false), renderLimit).
            map((value, i) => <div key={`log-${i}`}>
                <div className={"cell"}>
