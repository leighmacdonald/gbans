...
const hk = (
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-hk" viewBox="0 0 640 480">
        ...
        <g clipPath="url(#hk-a)" transform="translate(83.5) scale(.94)">
            ...
            <path fill="#ba0000" fillRule="evenodd" d="M244.6 154.5l3.3 5.5-6-2.5-4.7 5 .8-6.5-6-2.5 6.5-1.5.8-6.4 3.3 5.5 6.6-1.5" />
            <path
                fill="#fff"
                fillRule="evenodd"
            ...
            <path fill="#ba0000" fillRule="evenodd" d="M336.3 219.3L332 224l.6-6.5-6-3 6.3-1 .6-6.7 3.4 6 6.4-1.2-4.3 4.7 3.3 6" />
            <path
                fill="#fff"
                fillRule="evenodd"
            ...
            <path fill="#ba0000" fillRule="evenodd" d="M302.1 325.6l-5.9-2.6 6.5-1.5.8-6.7 3.1 5.7 6.5-1.5-4.5 5 3 5.7-5.8-2.6-4.5 5.1" />
            <path
                fill="#fff"
                fillRule="evenodd"
            ...
            <path fill="#ba0000" fillRule="evenodd" d="M189 325.4l.9-6.4 3.3 5.7 6.6-1-4.6 4.6 3.3 5.7-6.1-2.9-4.6 4.6.8-6.4-6.1-2.9" />
            <path
                fill="#fff"
                fillRule="evenodd"
            ...
            <path fill="#ba0000" fillRule="evenodd" d="M155.3 220l6.3-1.3-4.3 5 3.1 5.9-5.8-2.8-4.3 5 .7-6.8-5.9-2.8 6.3-1.3.7-6.8" />
        </g>
    </svg>
);
