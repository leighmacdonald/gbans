...
export const file_asset_v1_asset: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_google_protobuf_timestamp]);
...
export type DeleteResponse = Message<"asset.v1.DeleteResponse"> & {
  /**
   * @generated from field: int64 size = 1 [jstype = JS_STRING];
   */
  size: string;
};
 ...
 */
export const DeleteResponseSchema: GenMessage<DeleteResponse, {validType: DeleteResponseValid}> = /*@__PURE__*/
 ...
 */
export const AssetSchema: GenMessage<Asset, {validType: AssetValid}> = /*@__PURE__*/
