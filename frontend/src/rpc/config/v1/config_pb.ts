...
export const file_config_v1_config: GenFile =
	/*@__PURE__*/
	fileDesc(
		"",
 ...
 */
export const InfoResponseSchema: GenMessage<InfoResponse> = /*@__PURE__*/ messageDesc(file_config_v1_config, 0);
 ...
 */
export const GetResponseSchema: GenMessage<GetResponse> = /*@__PURE__*/ messageDesc(file_config_v1_config, 1);
 ...
 */
export const UpdateRequestSchema: GenMessage<UpdateRequest> = /*@__PURE__*/ messageDesc(file_config_v1_config, 2);
 ...
 */
export const UpdateResponseSchema: GenMessage<UpdateResponse> = /*@__PURE__*/ messageDesc(file_config_v1_config, 3);
 ...
 */
export const GeneralSchema: GenMessage<General> = /*@__PURE__*/ messageDesc(file_config_v1_config, 4);
 ...
 */
export const DebugSchema: GenMessage<Debug> = /*@__PURE__*/ messageDesc(file_config_v1_config, 5);
 ...
 */
export const DemoSchema: GenMessage<Demo> = /*@__PURE__*/ messageDesc(file_config_v1_config, 6);
 ...
 */
export const FiltersSchema: GenMessage<Filters> = /*@__PURE__*/ messageDesc(file_config_v1_config, 7);
 ...
 */
export const DiscordSchema: GenMessage<Discord> = /*@__PURE__*/ messageDesc(file_config_v1_config, 8);
 ...
 */
export const SourcemodSchema: GenMessage<Sourcemod> = /*@__PURE__*/ messageDesc(file_config_v1_config, 9);
 ...
 */
export const LogSchema: GenMessage<Log> = /*@__PURE__*/ messageDesc(file_config_v1_config, 10);
 ...
 */
export const GeoLocationSchema: GenMessage<GeoLocation> = /*@__PURE__*/ messageDesc(file_config_v1_config, 11);
 ...
 */
export const PatreonSchema: GenMessage<Patreon> = /*@__PURE__*/ messageDesc(file_config_v1_config, 12);
 ...
 */
export const SSHSchema: GenMessage<SSH> = /*@__PURE__*/ messageDesc(file_config_v1_config, 13);
 ...
 */
export const NetworkSchema: GenMessage<Network> = /*@__PURE__*/ messageDesc(file_config_v1_config, 14);
 ...
 */
export const LocalStoreSchema: GenMessage<LocalStore> = /*@__PURE__*/ messageDesc(file_config_v1_config, 15);
 ...
 */
export const ExportsSchema: GenMessage<Exports> = /*@__PURE__*/ messageDesc(file_config_v1_config, 16);
 ...
 */
export const AnticheatSchema: GenMessage<Anticheat> = /*@__PURE__*/ messageDesc(file_config_v1_config, 17);
 ...
 */
export const ClientprefsSchema: GenMessage<Clientprefs> = /*@__PURE__*/ messageDesc(file_config_v1_config, 18);
 ...
 */
export const ConfigSchema: GenMessage<Config> = /*@__PURE__*/ messageDesc(file_config_v1_config, 19);
