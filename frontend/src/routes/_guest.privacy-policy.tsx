			...
			<Grid container>
				...
				<PPBox heading={"How Your Information Is Being Used"}>
					<ul>
						...
						<li>
							<Typography variant={"body1"}>
								If the data indicates that a Violation has occurred, we will further store the data for
								the applicable statute of limitations or until a legal case related to it has been
								resolved. Please note that the specific data stored for this purpose may not be
				...
				<PPBox heading={"Cookies"}>
					<Typography variant={"body1"}>
						We use cookies on this site. A cookie is a piece of data stored on a site visitors computer to
						help us improve your access to our site and identify repeat visitors to our site. For instance,
						when we use a cookie to identify you, you would not have to log in a password more than once,
						thereby saving time while on our site. Cookies can also enable us to track and target the
						interests of our users to enhance the experience on our site. Usage of a cookie is in no way
				...
				<PPBox heading={"Who Has Access To Data"}>
					<ul>
						<li>
							<Typography variant={"body1"}>
								Information related to users accounts may be shared to approved 3rd parties for use in
								their own respective investigations and safety tools. This information is restricted to
								the Steam ID and general reason for ban of the associated account, if any exists.
							</Typography>
						</li>
						<li>
				...
				<PPBox heading={"Keeping your data secure"}>
					<Typography variant={"body1"}>
						...
						prevent unauthorized access or disclosure, we have put in place suitable measures and procedures
				...
				<PPBox heading={"Account Deletions"}>
					<Typography variant={"body1"}>
						...
						a reason is provided. Per GDPR Article 6(1)(f), {appInfo.site_name} is lawfully permitted to
						dismiss account deletion requests to protect the legitimate interests of our community by
				...
				<PPBox heading={"Data Usage and Retention"}>
					<Typography variant={"body1"}>
						...
						out in this Privacy Policy or as required by law. We will use your Personal Information to the
				...
				<PPBox heading={"Acceptance of this policy"}>
					<Typography variant={"body1"}>
						Continued use of our site and services signifies your acceptance of this policy. If you do not
						accept the policy then please do not use this site. When registering we will further request
						your explicit acceptance of the privacy policy.
					</Typography>
				</PPBox>
