...
import { ReportStatusField } from '../../component/formik/ReportStatusField.tsx';
...
import { reportStatusFieldValidator, sourceIdValidator, targetIdValidator } from '../../util/validators.ts';

export const Route = createLazyFileRoute('/_auth/admin/reports')({
    ...
    return (
        ...
        >
            <Grid container spacing={2}>
                ...
                <Grid xs={12}>
                    <ContainerWithHeader title={'Current User Reports'} iconLeft={loading ? <LoadingIcon /> : <ReportIcon />}>
                        <LazyTable
                            showPager={true}
                            count={count}
                            rows={data}
