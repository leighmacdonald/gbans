...
export const Route = createLazyFileRoute('/_authoptional/contests/$contest_id')({
    component: Contest
});
...
function Contest() {
    ...
    const { hasPermission, userSteamID } = useRouteContext({ from: '/_authoptional/contests/$contest_id' });
