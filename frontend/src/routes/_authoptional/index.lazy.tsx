...
import { createLazyFileRoute, useNavigate, Link as RouterLink, useRouteContext } from '@tanstack/react-router';
import { NewsView } from '../../component/NewsView';

export const Route = createLazyFileRoute('/_authoptional/')({
    component: Index
});

function Index() {
    const navigate = useNavigate();
    const { user } = useRouteContext({ from: '/_authoptional/' });
    return (
