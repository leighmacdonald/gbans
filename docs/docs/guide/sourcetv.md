...
Some functionality, such as [player stats](stats.md) and pulling steam ids from demos for searching, requires a instance
of [tf2_demostats](https://github.com/leighmacdonald/tf2_demostats) to also be configured.
